...
CMAKE_BUILD_OPT ?=
CMAKE_CONFIGURE_OPT ?= -DCMAKE_POLICY_VERSION_MINIMUM=3.5
ifdef V
	CMAKE_BUILD_OPT += -v
...
ifdef CMAKE_INSTALL_LIBDIR
	CMAKE_CONFIGURE_OPT += -DCMAKE_INSTALL_LIBDIR=${CMAKE_INSTALL_LIBDIR}
endif
ifdef CMAKE_INSTALL_INCLUDEDIR
	CMAKE_CONFIGURE_OPT += -DCMAKE_INSTALL_INCLUDEDIR=${CMAKE_INSTALL_INCLUDEDIR}
endif
ifdef CMAKE_BUILD_TYPE
	CMAKE_CONFIGURE_OPT += -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
endif
ifdef BUILD_TESTING
