...
static auto syntaxTestdata = testing::Values(
		...
		TestdataSyntax("assign_var3",
			SC_NoCondition,
			OWN_INPUT("assign_var3")),
		TestdataSyntax("assign_var4",
			SC_NoCondition,
			OWN_INPUT("assign_var4")),
		TestdataSyntax("assign_var5",
			SC_NoCondition,
			OWN_INPUT("assign_var5")),
		TestdataSyntax("assign_var6",
			SC_NoCondition,
			OWN_INPUT("assign_var6")),
		TestdataSyntax("assign_var7",
			SC_NoCondition,
			OWN_INPUT("assign_var7")),
		TestdataSyntax("assign_var8",
			SC_NoCondition,
			OWN_INPUT("assign_var8")),
		TestdataSyntax("assign_var9",
			SC_NoCondition,
