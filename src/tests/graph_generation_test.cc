...
static auto syntaxTestdata = testing::Values(
		...
		TestdataSyntax("assign_var02",
			SC_NoCondition,
			OWN_INPUT("assign_var2")),
		TestdataSyntax("assign_var03",
			SC_NoCondition,
			OWN_INPUT("assign_var3")),
		TestdataSyntax("assign_var04",
			SC_NoCondition,
			OWN_INPUT("assign_var4")),
		TestdataSyntax("assign_var05",
			SC_NoCondition,
			OWN_INPUT("assign_var5")),
		TestdataSyntax("assign_var06",
			SC_NoCondition,
			OWN_INPUT("assign_var6")),
		TestdataSyntax("assign_var07",
			SC_NoCondition,
			OWN_INPUT("assign_var7")),
		TestdataSyntax("assign_var08",
			SC_NoCondition,
			OWN_INPUT("assign_var8")),
		TestdataSyntax("assign_var09",
			SC_NoCondition,
			OWN_INPUT("assign_var9")),
		TestdataSyntax("assign_var10",
			SC_NoCondition,
			OWN_INPUT("assign_var10")),
		TestdataSyntax("assign_var11",
			SC_NoCondition,
			OWN_INPUT("assign_var11")),
		TestdataSyntax("assign_var12",
			SC_NoCondition,
			OWN_INPUT("assign_var12")),
		TestdataSyntax("assign_var13",
			SC_NoCondition,
			OWN_INPUT("assign_var13")),
		TestdataSyntax("assign_var14",
			SC_NoCondition,
			OWN_INPUT("assign_var14")),
		TestdataSyntax("assign_var15",
			SC_NoCondition,
			OWN_INPUT("assign_var15")),
		TestdataSyntax("assign_var16",
			SC_NoCondition,
			OWN_INPUT("assign_var16")),
		TestdataSyntax("assign_var17",
			SC_NoCondition,
			OWN_INPUT("assign_var17")),
		TestdataSyntax("failed_assign_var1",
			SC_NoCondition,
			OWN_INPUT("failed_assign_var1"),
			false),
		TestdataSyntax("failed_assign_var2",
			SC_NoCondition,
			OWN_INPUT("failed_assign_var2"),
			false),
