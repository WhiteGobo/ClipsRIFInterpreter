...
"_:assertA cs:assert _:rhspattern.\n"
"_:rhspattern cs:deftemplate-name \"TripleTemplate\";"
"    cs:slot(\n"
"        [cs:slot-name \"subject\"; cs:field (_:varA)]\n"
"        [cs:slot-name \"predicate\"; cs:field (_:literalA)]\n"
"        [cs:slot-name \"object\"; cs:field (_:uriA)]\n"
"    )."
;
