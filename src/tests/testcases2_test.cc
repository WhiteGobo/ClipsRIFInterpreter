...
static auto petTestdata = testing::Values(
		...
		TestdataPET("Core_PET_RDF_Combination_Constant_Equivalence_4",
			...
			"RDF_Combination_Constant_Equivalence_4-premise",
			"RDF_Combination_Constant_Equivalence_4-conclusion"),
		TestdataPET("Core_PET_RDF_Combination_Constant_Equivalence_Graph_Entailment",
			SC_All,
			"not implemented",
			_W3C_TESTDATA_"/",
				"RDF_Combination_Constant_Equivalence_Graph_Entailment-premise",
				"RDF_Combination_Constant_Equivalence_Graph_Entailment-conclusion"),
		TestdataPET("Core_PET_RDF_Combination_SubClass_2",
			SC_All,
			"not implemented",
			_W3C_TESTDATA_"/",
				"RDF_Combination_SubClass_2-premise",
				"RDF_Combination_SubClass_2-conclusion"),
		...
		TestdataPET("BLD_PET_IRI_from_IRI",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"IRI_from_IRI-premise",
				"IRI_from_IRI-conclusion"),
		TestdataPET("BLD_PET_Inconsistent_Entailment",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Inconsistent_Entailment-premise",
				"Inconsistent_Entailment-conclusion"),
		TestdataPET("BLD_PET_Individual-Data_Separation_Inconsistency",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Individual-Data_Separation_Inconsistency-premise",
				"Individual-Data_Separation_Inconsistency-conclusion"),
		TestdataPET("BLD_PET_ListConstantEquality",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"ListConstantEquality-premise",
				"ListConstantEquality-conclusion"),
		TestdataPET("BLD_PET_ListEqualityFromElementEquality",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"ListEqualityFromElementEquality-premise",
				"ListEqualityFromElementEquality-conclusion"),
		TestdataPET("BLD_PET_ListLiteralEquality",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"ListLiteralEquality-premise",
				"ListLiteralEquality-conclusion"),
		TestdataPET("BLD_PET_Arbitrary_Entailment",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Arbitrary_Entailment-premise",
				"Arbitrary_Entailment-conclusion"),
		TestdataPET("BLD_PET_Multiple_IRIs_from_String",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Multiple_IRIs_from_String-premise",
				"Multiple_IRIs_from_String-conclusion"),
		TestdataPET("BLD_PET_Multiple_Strings_from_IRI",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Multiple_Strings_from_IRI-premise",
				"Multiple_Strings_from_IRI-conclusion"),
		TestdataPET("BLD_PET_Named_Arguments",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"Named_Arguments-premise",
				"Named_Arguments-conclusion"),
		TestdataPET("BLD_PET_RDF_Combination_Member_1",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"RDF_Combination_Member_1-premise",
				"RDF_Combination_Member_1-conclusion"),
		TestdataPET("BLD_PET_RDF_Combination_SubClass_4",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"RDF_Combination_SubClass_4-premise",
				"RDF_Combination_SubClass_4-conclusion"),
		TestdataPET("BLD_PET_RDF_Combination_SubClass_6",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"RDF_Combination_SubClass_6-premise",
				"RDF_Combination_SubClass_6-conclusion"),
		TestdataPET("BLD_PET_YoungParentDiscount_1",
			SC_All,
				"not implemented",
			_W3C_TESTDATA_"/",
				"YoungParentDiscount_1-premise",
				"YoungParentDiscount_1-conclusion"),
