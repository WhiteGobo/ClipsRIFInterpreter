...
static auto petTestdata = testing::Values(
		...
		TestdataPET("Own_BLD_PET_circular_patterns2",
			...
			false),
		TestdataPET("Own_PET_Membership",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("Membership"),
			OWN_CONCLUSION("Membership")),
		TestdataPET("Own_PET_Subclass",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("Subclass"),
			OWN_CONCLUSION("Subclass")),
		TestdataPET("Own_PET_actionvar1",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("actionvar1"),
			OWN_CONCLUSION("actionvar1")),
		TestdataPET("Own_PET_actionvar2",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("actionvar2"),
			OWN_CONCLUSION("actionvar2")),
		TestdataPET("OWN_PRD_PET_priority1",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("PRD_priority1"),
			OWN_CONCLUSION("PRD_priority1")),
		TestdataPET("OWN_PRD_PET_priority2",
			SC_NoCondition | SC_ModelFirst,
			OWN_PREMISE("PRD_priority2"),
			OWN_CONCLUSION("PRD_priority2")),
...
static void create_logic_into_memory(FILE* tmpmem_f, TestdataPET testdata,
					...
					const char* model_log_file_name)
{
	...
	FILE* model_log_file = fopen(model_log_file_name, "a");
	fprintf(model_log_file, "activations for %s\n", testdata.name.c_str());
	fprint_activities_per_rule(model_log_file, create_logic_graph);
	fprintf(model_log_file, "\n\n");
