...
(defrule rule-gen3422 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen3426 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3433 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3440 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen3447 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen3454 (declare (salience 10))
	(Member
...
(defrule rule-gen3472 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
...
(defrule rule-gen3476 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen3486 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen3740 
	...
	(not(exists 	(TripleTemplate
		...
		(object ?arglist))))
		=>
(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen3750 
	(TripleTemplate
		...
		(object ?arglist))
		=>
(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen3767 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen3771 
	(TripleTemplate
		...
		(object ?subj))
		=>
(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?funccheck (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
...
(defrule rule-gen3797 
	(TripleTemplate
		...
		(object ?obj))
		=>
(bind ?slotobj (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?query) (eq ?trpl:predicate <http://clips.script/function-args>))
...
(defrule rule-gen3810 
	(TripleTemplate
		...
		(object ?exprinstance))
		=>
(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?checkclass (<http://white.gobo/new-blanknode>))(bind ?checkinstance (<http://white.gobo/new-blanknode>))(bind ?slotclass (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?checkmember (<http://white.gobo/new-blanknode>))(bind ?slotinstance (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifmember)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
...
(defrule rule-gen3823 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?query (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?checktriple (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
