...
(defrule rule-gen4717 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen4721 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen4728 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen4735 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen4821 (declare (salience -1))
	(Member
		(instance ?riflist)
...
(defrule rule-gen4836 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen4881 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen4959 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen4966 (declare (salience 10))
	(Member
...
(defrule rule-gen4984 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen4994 (declare (salience -100))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen5003 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
