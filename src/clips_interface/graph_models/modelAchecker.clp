...
(defrule rule-gen6529 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen6533 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen6540 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen6547 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen6554 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen6561 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen6568 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen6583 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen6597 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen6633 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen6647 (declare (salience 100))
	(TripleTemplate
		(subject ?rifnot)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23give-inheritance%3E)
		(object ?target))
...
(defrule rule-gen6659 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen6669 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen6685 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen6691 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
...
(defrule rule-gen6698 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen6706 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen6719 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen6732 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen6745 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen6794 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen6810 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen6823 (declare (salience 100))
	(Atom
...
(defrule rule-gen6830 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
	(or 	(TripleTemplate
...
(defrule rule-gen6886 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen6908 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen6915 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen6929 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen6943 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
	(or 	(TripleTemplate
...
(defrule rule-gen7008 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen7022 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen7026 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen7032 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen7041 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen7051 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen7055 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen7060 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(Member
...
(defrule rule-gen7083 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen7106 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen7124 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen7145 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen7155 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen7173 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen7188 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen7206 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen7219 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen7226 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen7276 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen7394 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen7404 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
		(predicate <http://www.w3.org/2007/rif#constname>)
		(object ?name))
...
(defrule rule-gen7413 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen7422 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen7444 (declare (salience -1))
	(Atom
...
(defrule rule-gen7450 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen7464 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
