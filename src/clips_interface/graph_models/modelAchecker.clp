...
(defrule rule-gen5389 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen5444 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5465 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen5471 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5484 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen5497 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5561 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://example.com/inherits-data>)
		(object ?child))
...
(defrule rule-gen5574 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen5578 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5592 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen5599 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen5603 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen5609 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5632 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5637 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5659 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5682 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5699 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5719 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen5729 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen5747 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5762 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5789 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen5796 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen5846 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen5964 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen5974 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
...
(defrule rule-gen5983 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen5992 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen6014 (declare (salience -1))
	(Atom
...
(defrule rule-gen6020 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen6034 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
