...
(defrule rule-gen5652 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen5656 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5663 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5670 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen5677 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
...
(defrule rule-gen5683 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5706 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5711 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5733 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5773 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5793 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?itemlist))
...
(defrule rule-gen5809 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
		(predicate _:qqadd-args-as-constraints-from)
		(object ?itemlist))
...
(defrule rule-gen5819 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
		(predicate _:qqadd-args-as-constraints-from)
		(object ?itemlist))
...
(defrule rule-gen5832 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen5850 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5865 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5888 
	...
	(not(exists 	(TripleTemplate
		...
		(object ?arglist))))
		=>
(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5898 
	(TripleTemplate
		...
		(object ?arglist))
		=>
(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5915 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen5958 
	(TripleTemplate
		...
		(object ?exprinstance))
		=>
(bind ?checkinstance (<http://white.gobo/new-blanknode>))(bind ?checkclass (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?checkmember (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?slotinstance (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?slotclass (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifmember)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
...
(defrule rule-gen5971 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?checktriple (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
...
(defrule rule-gen6002 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen6009 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen6027 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen6037 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen6046 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
