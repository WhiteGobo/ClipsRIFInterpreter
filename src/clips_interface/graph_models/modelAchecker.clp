...
(defrule rule-gen5212 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen5216 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5223 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5230 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen5237 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
...
(defrule rule-gen5243 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5266 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5271 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen5293 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
		...
		(object ?assign))
		=>
(bind ?position (<http://white.gobo/new-blanknode>))(bind ?eq (<http://white.gobo/new-blanknode>))(bind ?function (<http://white.gobo/new-blanknode>))(bind ?testpattern (<http://white.gobo/new-blanknode>))	(assert 	(Member
...
(defrule rule-gen5316 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5333 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen5353 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen5363 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen5381 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5396 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen5419 
	...
	(not(exists 	(TripleTemplate
		...
		(object ?arglist))))
		=>
(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5429 
	(TripleTemplate
		...
		(object ?arglist))
		=>
(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5446 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(bind ?funccheck (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		...
		(bind ?querylist ?trpl:object))(bind ?slotsubj (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?slotsubj)
		(predicate <http://clips.script/member-variable>)
		(object ?factvar)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5489 
	(TripleTemplate
		...
		(object ?exprinstance))
		=>
(bind ?checkclass (<http://white.gobo/new-blanknode>))(bind ?slotclass (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?checkmember (<http://white.gobo/new-blanknode>))(bind ?checkinstance (<http://white.gobo/new-blanknode>))(bind ?slotinstance (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifmember)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
...
(defrule rule-gen5502 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?anyfactp (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?checktriple (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/as-test-action>)
		(object ?anyfactp)))
	(assert 	(Member
...
(defrule rule-gen5553 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen5560 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen5588 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen5597 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen5694 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?atom))
...
(defrule rule-gen5709 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen5723 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5781 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen5789 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://example.com/inherits-data>)
		(object ?child))
