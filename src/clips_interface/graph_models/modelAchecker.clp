...
(defrule rule-gen2050 
	...
	(assert 	(TripleTemplate
		(subject <http://example.com/brubru>)
		(predicate <http://example.com/brubru>)
		(object (<http://www.w3.org/2007/rif-builtin-function#numeric-add> ?factindex "1^^http://www.w3.org/2001/XMLSchema#integer" ))))
	(assert 	(TripleTemplate
		(subject ?factvar)
		(predicate <http://clips.script/variable-name>)
...
(do-for-fact ((?trpl TripleTemplate))
		...
		(bind ?querylist ?trpl:object))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
...
(defrule rule-gen2066 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?funccheckpred (<http://white.gobo/new-blanknode>))(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?slotobj (<http://white.gobo/new-blanknode>))(bind ?funcchecksubj (<http://white.gobo/new-blanknode>))(bind ?slotpred (<http://white.gobo/new-blanknode>))(bind ?funccheckobj (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject <http://example.com/qqfactquery>) (eq ?trpl:predicate <http://clips.script/function-args>))
		(bind ?querylist ?trpl:object))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?factvar)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/Variable>)))
	(assert 	(TripleTemplate
...
(deffacts rule-gen2088
		(Atom
		(op <http://example.com/currentfactindex>)
		(args "1^^http://www.w3.org/2001/XMLSchema#integer" )))

(deffacts rule-gen2089
		(Atom
		(op <http://example.com/brubru>)
		(args )))

(deffacts rule-gen2090
		(TripleTemplate
		(subject <http://example.com/rootfunction>)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/AnyFactP>)))

(deffacts rule-gen2091
		(TripleTemplate
		(subject <http://example.com/rootfunction>)
		(predicate <http://clips.script/query>)
		(object <http://example.com/qqfactquery>)))

(deffacts rule-gen2092
		(TripleTemplate
		(subject <http://example.com/qqfactquery>)
		(predicate <http://clips.script/function-name>)
		(object "and")))

(deffacts rule-gen2093
		(TripleTemplate
		(subject <http://example.com/qqfactquery>)
		(predicate <http://clips.script/function-args>)
		(object (<http://www.w3.org/2007/rif-builtin-function#make-list> ))))
...
(defrule rule-gen2094 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen2098 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen2105 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen2112 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
