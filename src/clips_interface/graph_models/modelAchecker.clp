...
(defrule rule-gen3683 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen3687 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3694 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3701 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen3708 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen3715 (declare (salience 10))
	(Member
...
(defrule rule-gen3733 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
...
(defrule rule-gen3737 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen3747 (declare (salience -100))
	(Member
		(instance ?clipsvar)
...
(defrule rule-gen3756 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen4083 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
