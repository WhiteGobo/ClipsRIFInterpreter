...
(defrule rule-gen5687 (declare (salience 80))
	(TripleTemplate
		(subject ?child)
...
(defrule rule-gen5691 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen5706 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen5713 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5728 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5740 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?arglist))
...
(defrule rule-gen5756 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen5792 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen5806 (declare (salience 100))
	(TripleTemplate
		(subject ?rifnot)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23give-inheritance%3E)
		(object ?target))
...
(defrule rule-gen5818 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen5828 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen5844 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen5850 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
...
(defrule rule-gen5857 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen5865 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen5878 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen5891 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen5904 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen5953 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen5969 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen5982 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen5986 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5993 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen6000 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen6007 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen6011 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen6017 (declare (salience 10))
	(Member
	...
	(test (eq ?targetitem (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist "1^^http://www.w3.org/2001/XMLSchema#integer" )))
		...
		(object ?itemvar))
		=>
(bind ?rightspace (<http://white.gobo/new-blanknode>))(bind ?pattern (<http://white.gobo/new-blanknode>))(bind ?slotitems (<http://white.gobo/new-blanknode>))(bind ?assign (<http://white.gobo/new-blanknode>))(bind ?leftspace (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifexternal)
...
(defrule rule-gen6036 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen6045 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen6055 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen6059 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen6064 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
...
(defrule rule-gen6087 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen6097 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen6115 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen6130 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
	...
	(not 	(TripleTemplate
		...
		(object ?defrule)))
		=>
(bind ?tmplistasvar (<http://white.gobo/new-blanknode>))(bind ?testvarpattern (<http://white.gobo/new-blanknode>))(bind ?testvaraction (<http://white.gobo/new-blanknode>))(bind ?assignpattern (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
...
(defrule rule-gen6148 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen6161 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen6168 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen6218 (declare (salience -100))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://example.com/add-expressions-as-args>)
		(object ?rifrestargs))
...
(defrule rule-gen6336 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen6346 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
		(predicate <http://www.w3.org/2007/rif#constname>)
		(object ?name))
...
(defrule rule-gen6355 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen6364 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen6386 (declare (salience -1))
	(Atom
...
(defrule rule-gen6392 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen6406 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen6467 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen6471 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen6475 (declare (salience 60))
	(Member
		(instance ?rifdocument)
		(class <http://www.w3.org/2007/rif#Document>))
		(TripleTemplate
