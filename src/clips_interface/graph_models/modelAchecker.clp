...
(defrule rule-gen241 
	...
	(assert 	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/brubru>)
		(object <http://example.com/brubru>)))

)
(deffacts rule-gen245
		(TripleTemplate
...
(defrule rule-gen246 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen250 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen257 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen264 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
