...
(defrule rule-gen4965 
	...
	(not(exists 	(TripleTemplate
		...
		(object ?arglist))))
		=>
(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject <http://example.com/qqfactquery>) (eq ?trpl:predicate <http://clips.script/function-args>))
		(bind ?querylist ?trpl:object))(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
...
(defrule rule-gen4975 
	(TripleTemplate
		...
		(object ?arglist))
		=>
(bind ?funccheckargs (<http://white.gobo/new-blanknode>))(bind ?generateargscompare (<http://white.gobo/new-blanknode>))(bind ?varargs (<http://white.gobo/new-blanknode>))(bind ?funccheckop (<http://white.gobo/new-blanknode>))(bind ?varop (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject <http://example.com/qqfactquery>) (eq ?trpl:predicate <http://clips.script/function-args>))
...
(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject <http://example.com/qqfactquery>) (eq ?trpl:predicate <http://clips.script/function-args>))
		(bind ?querylist ?trpl:object))(bind ?slotpred (<http://white.gobo/new-blanknode>))(bind ?slotobj (<http://white.gobo/new-blanknode>))(bind ?funcchecksubj (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?funccheckpred (<http://white.gobo/new-blanknode>))(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?funccheckobj (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?factvar)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/Variable>)))
	(assert 	(TripleTemplate
...
(defrule rule-gen5012 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen5016 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5023 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen5030 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
