...
(defrule rule-gen1554 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?funccheckpred (<http://white.gobo/new-blanknode>))(bind ?funccheckobj (<http://white.gobo/new-blanknode>))(bind ?funcchecksubj (<http://white.gobo/new-blanknode>))(bind ?slotobj (<http://white.gobo/new-blanknode>))(bind ?slotpred (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
...
(defrule rule-gen1585 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen1592 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen1599 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
