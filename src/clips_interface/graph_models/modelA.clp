...
(or 	(Member
	...
	(assert 	(TripleTemplate
		...
		(predicate <http://example.com/a#wantstoaddlist>)
		(object ?formulalist)))
	(assert 	(TripleTemplate
		(subject ?superpattern)
		(predicate <http://example.com/a#wantstoadd>)
		(object ?formula)))
