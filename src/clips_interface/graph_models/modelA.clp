...
(defrule rule-gen12880 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen12887 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen12905 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
...
(defrule rule-gen12911 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://example.com/ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen12934 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen12939 (declare (salience 10))
	(Member
		(instance ?riflist)
...
(defrule rule-gen13001 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen13021 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen13031 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen13049 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen13064 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen13082 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen13092 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen13101 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen13141 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen13181 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?atom))
...
(defrule rule-gen13196 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen13203 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen13210 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?childlist))
...
(defrule rule-gen13268 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen13277 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://example.com/inherits-data>)
		(object ?child))
...
(defrule rule-gen13435 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen13442 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen13449 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen13462 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13473 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13480 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(deffacts rule-gen13526
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen13527 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen13538 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentencelist))
...
(defrule rule-gen13546 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13561 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13571 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13581 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13597 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13628 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen13673 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate _:qqadd-atom-args-as-constraint)
		(object ?arglist))
...
(defrule rule-gen13798 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen13805 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen13809 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?gen13812))	=>
...
(defrule rule-gen13911 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen13915 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen14398 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen14424 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen14453 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate _:qqtransfer-after-conditions)
		(object ?andpattern))
...
(defrule rule-gen14483 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen14496 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen14531 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifatom))
...
(defrule rule-gen14543 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen14555 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14576 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14602 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14628 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen14660 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
