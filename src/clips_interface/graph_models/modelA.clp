...
(defrule rule-gen16713 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16722 (declare (salience 10))
	(TripleTemplate
		(subject ?super)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?sub))
...
(defrule rule-gen16742 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16753 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16760 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16837 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16852 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16888 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
...
(defrule rule-gen16920 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16952 (declare (salience -100))
	(Member
		(instance ?rifnode)
...
(defrule rule-gen16961 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen17046 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen17059 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen17066 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen17084 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen17098 (declare (salience 100))
	(TripleTemplate
		(subject ?clause)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?assert))
...
(defrule rule-gen17108 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen17128 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17138 (declare (salience 100))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17181 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#if>)
		(object ?formula))
...
(defrule rule-gen17188 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17220 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17228 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen17261 (declare (salience 100))
(or 	(Member
		(instance ?rifformula)
		(class <http://www.w3.org/2007/rif#Atom>))
		(Member
...
(defrule rule-gen17268 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17295 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen17316 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17324 (declare (salience 100))
	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?action))	=>
...
(defrule rule-gen17328 (declare (salience 100))
(or 	(Member
		(instance ?action)
...
(defrule rule-gen17365 (declare (salience 100))
	(Member
		(instance ?rifand)
		(class <http://white.gobo/modelA#ActionGenerator>))
		(Member
...
(defrule rule-gen17416 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen17423 (declare (salience 80))
	(TripleTemplate
		(subject ?child)
...
(defrule rule-gen17427 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actions>)
		(object ?childlist))
...
(defrule rule-gen17442 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen17464 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?arglist))
...
(defrule rule-gen17478 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#op>)
		(object ?child))
...
(defrule rule-gen17514 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17528 (declare (salience 100))
	(TripleTemplate
		(subject ?rifnot)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23give-inheritance%3E)
		(object ?target))
...
(defrule rule-gen17540 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen17550 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen17566 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen17572 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?group))
...
(defrule rule-gen17579 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen17587 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen17613 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen17626 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen17675 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen17691 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen17797 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17828 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen17933 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17961 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen18108 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen18118 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
		(predicate <http://www.w3.org/2007/rif#constname>)
		(object ?name))
...
(defrule rule-gen18127 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen18136 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen18158 (declare (salience -1))
	(Atom
...
(defrule rule-gen18164 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen18178 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen18239 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen18243 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object ?iristring))
...
(defrule rule-gen18247 (declare (salience 60))
	(Member
		(instance ?rifdocument)
		(class <http://www.w3.org/2007/rif#Document>))
		(TripleTemplate
...
(defrule rule-gen18256 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen18260 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen18266 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18275 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen18285 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen18289 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen18327 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen18345 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen18360 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen18378 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen18385 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen18392 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen18396 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen18400 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18421 (declare (salience 5))
	(Member
		(instance ?rifvar)
		(class <http://www.w3.org/2007/rif#Var>))
		(TripleTemplate
...
(defrule rule-gen18427 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://example.com/ConstraintGenerator>))
		(TripleTemplate
...
(defrule rule-gen18436 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen18453 (declare (salience 5))
	(Member
		(instance ?rifrule)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen18472 (declare (salience 5))
(or 	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
		(Member
...
(defrule rule-gen18503 (declare (salience 5))
	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18512 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen18548 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?itemlist))
...
(defrule rule-gen18557 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?rifvar))
...
(defrule rule-gen18610 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18628 (declare (salience 5))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?arglist))
...
(defrule rule-gen18635 (declare (salience 5))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18652 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18684 (declare (salience 5))
	(Member
		(instance ?rifequal)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18693 (declare (salience 5))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18729 (declare (salience 5))
	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?rifatom))
...
(defrule rule-gen18761 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-expression-needs-var%3E))
		(TripleTemplate
...
(defrule rule-gen18780 (declare (salience 5))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen18788 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Or>))
		=>
...
(defrule rule-gen18791 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#INeg>))
		=>
...
(defrule rule-gen18794 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen18803 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen18817 (declare (salience 11))
	(Atom
...
(defrule rule-gen18831 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18844 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		=>
...
(defrule rule-gen18847 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
	(not(exists (and 	(TripleTemplate
...
(defrule rule-gen18861 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18905 (declare (salience 20))
	(TripleTemplate
		(subject ?rifand)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?otherrifand))
...
(defrule rule-gen18924 (declare (salience 20))
	(TripleTemplate
		(subject ?rifforall)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifrule))
...
(defrule rule-gen18942 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen18970 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen19001 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen19040 (declare (salience 5))
	(Member
...
(defrule rule-gen19049 (declare (salience 5))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-variable-binding%3E)
		(object ?formulacontainer))
...
(defrule rule-gen19056 (declare (salience 5))
(or 	(Member
		(instance ?formulacontainer)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen19069 (declare (salience 5))
(or 	(Member
		(instance ?rifnot)
		(class <http://www.w3.org/2007/rif#INeg>))
		(Member
...
(defrule rule-gen19083 (declare (salience 5))
	(Member
		(instance ?riflist)
...
(defrule rule-gen19089 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen19114 (declare (salience 5))
	(Member
...
(defrule rule-gen19128 (declare (salience 5))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen19145 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen19158 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen19168 (declare (salience -7))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen19182 (declare (salience -7))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19205 (declare (salience -7))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen19223 (declare (salience -8))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen19257 (declare (salience -9))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen19285 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen19310 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen19322 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen19334 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen19346 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen19375 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19398 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19421 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen19438 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen19460 (declare (salience 5))
	(TripleTemplate
		(subject ?rifvar)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23use-expression-from%3E)
...
(defrule rule-gen19592 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen19599 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen19603 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
