...
(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldpatternlist ?trpl:object))(bind ?pattern (<http://white.gobo/new-blanknode>))(bind ?action (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?pattern)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/TestCE>)))
	(do-for-all-facts ((?fct TripleTemplate)) 
...
(defrule rule-gen18160 (declare (salience 10))
	(TripleTemplate
		(subject ?group)
...
(defrule rule-gen18170 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen18180 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen18190 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen18203 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen18210 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen18247 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen18556 
	...
	(not 	(TripleTemplate
		...
		(object ?slot)))
		=>
(bind ?slotpredicate (<http://white.gobo/new-blanknode>))(bind ?clipsconditionalelement (<http://white.gobo/new-blanknode>))(bind ?slotsubject (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?rifnode) (eq ?trpl:predicate <http://example.com/in-as-conditional>))
		(bind ?existingconditionals ?trpl:object))(bind ?slotobject (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://example.com/used-slot-for-conditional>)
		(object ?slot)))
	(do-for-all-facts ((?fct TripleTemplate)) 
...
(defrule rule-gen18645 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
...
(defrule rule-gen18664 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen18674 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen18678 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen18685 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen18692 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
