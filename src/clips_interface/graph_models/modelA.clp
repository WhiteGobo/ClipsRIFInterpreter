...
(defrule rule-gen14594 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
...
(defrule rule-gen14625 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen14658 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen14662 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen14669 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen14683 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen14687 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen15022 
	...
	(assert 	(TripleTemplate
		(subject ?term)
		(predicate _:qqexpression-needs-variable)
		(object ?clipsvar)))
	(assert 	(TripleTemplate
		(subject ?term)
		(predicate _:qqconstraint-needs-variable)
...
(defrule rule-gen15069 (declare (salience -100))
(or 	(Member
...
(defrule rule-gen15132 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen15143 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifframe))
...
(defrule rule-gen15168 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifatom))
...
(defrule rule-gen15180 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen15192 (declare (salience -1))
	(Atom
		(op _:qqalways-false)
		(args ))
		(TripleTemplate
...
(defrule rule-gen15205 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen15226 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen15252 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen15278 (declare (salience -1))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen15310 (declare (salience -1))
	(Atom
		(op _:qqalways-false)
		(args ))
		(TripleTemplate
...
(defrule rule-gen15325 (declare (salience -1))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
...
(bind ?position (<http://white.gobo/new-blanknode>))(bind ?function (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
	...
	(assert 	(TripleTemplate
		(subject ?position)
		(predicate <http://clips.script/string>)
		(object (<http://white.gobo/literal-to-clipsconstant> (<http://www.w3.org/2007/rif-builtin-function#index-of> ?itemlist ?rifvar ) ))))

)

(defrule rule-gen15455 
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?itemlist))
...
(defrule rule-gen15507 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen15522 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
	...
	(not 	(TripleTemplate
		...
		(object ?defrule)))
		=>
(bind ?tmplistasvar (<http://white.gobo/new-blanknode>))(bind ?assignpattern (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
...
(defrule rule-gen15540 (declare (salience 10))
	(Atom
		(op _:qqalways-false)
		(args ))
		(TripleTemplate
...
(defrule rule-gen15549 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen15559 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen15569 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen15580 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen15587 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15616 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(deffacts rule-gen15633
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen15634 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen15645 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentencelist))
...
(defrule rule-gen15653 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15668 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15678 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15688 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15822 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen15829 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen15833 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?gen15836))	=>
...
(defrule rule-gen15886 (declare (salience -101))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15924 (declare (salience -1))
	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15936 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15959 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15982 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16002 (declare (salience -1))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16015 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-as-constraint>)
		(object ?arglist))
...
(defrule rule-gen16022 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-as-constraint>)
		(object ?gen16025))	=>
...
(defrule rule-gen16027 (declare (salience -1))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16045 (declare (salience -1))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16091 (declare (salience 50))
	(TripleTemplate
		(subject ?clipsfunction)
		(predicate <http://clips.script/function-args>)
		(object ?arglist))
...
(defrule rule-gen16097 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(<http://white.gobo/set-graph-in-errorstate> (<http://www.w3.org/2007/rif-builtin-function#concat> "Missing%20binding%20for%20rif%3AVar%20with%20name%20" ?varname "%20%28modelA%3Amissing-var-binding%29" ) )
)
;autogenerated group rules

(defrule rule-gen16107 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen16116 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen16456 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate _:qqadd-atom-args-as-constraint)
		(object ?arglist))
...
(defrule rule-gen16472 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen16479 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen16593 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
...
(defrule rule-gen16612 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
