...
(defrule rule-gen7105 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen7109 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen7116 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen7123 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen7130 (declare (salience 10))
	(TripleTemplate
		(subject ?group)
...
(defrule rule-gen7140 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen7150 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen7160 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen7173 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen7180 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7220 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen7230 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen7237 (declare (salience 10))
	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#External>))
...
(defrule rule-gen7313 
	(TripleTemplate
		...
		(object ?clipsterm))
		=>
(bind ?tripletemplate (<http://white.gobo/new-blanknode>))(bind ?triplequery (<http://white.gobo/new-blanknode>))(bind ?clipsretract (<http://white.gobo/new-blanknode>))(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?tmpvar (<http://white.gobo/new-blanknode>))(bind ?expandtriples (<http://white.gobo/new-blanknode>))(bind ?findtriples (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifretract)
		(predicate <http://example.com/as-action>)
...
(defrule rule-gen7323 
	(TripleTemplate
		...
		(object ?subjterm))
		=>
(bind ?clipsassert (<http://white.gobo/new-blanknode>))(bind ?comparepredicate (<http://white.gobo/new-blanknode>))(bind ?comparesubject (<http://white.gobo/new-blanknode>))(bind ?tripletemplate (<http://white.gobo/new-blanknode>))(bind ?tmpvar (<http://white.gobo/new-blanknode>))(bind ?clipsretractall (<http://white.gobo/new-blanknode>))(bind ?comparesubjectandpredicate (<http://white.gobo/new-blanknode>))(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?clipsretractvar (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?tmpvar)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/Variable>)))
	(assert 	(TripleTemplate
...
(defrule rule-gen7389 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen7396 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?gen7399))	=>
...
(do-for-fact ((?trpl TripleTemplate))
		...
		(bind ?existingconditionals ?trpl:object))(bind ?slotobject (<http://white.gobo/new-blanknode>))(bind ?slotpredicate (<http://white.gobo/new-blanknode>))(bind ?slotsubject (<http://white.gobo/new-blanknode>))(bind ?clipsconditionalelement (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://example.com/used-slot-for-conditional>)
		(object ?slot)))
	(do-for-all-facts ((?fct TripleTemplate)) 
...
(defrule rule-gen7526 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
...
(defrule rule-gen7545 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen7569 (declare (salience -100))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7610 (declare (salience -1))
	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7623 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7648 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7673 (declare (salience -1))
	(TripleTemplate
		(subject ?rifequal)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(bind ?pattern (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldpatternlist ?trpl:object))(bind ?action (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?pattern)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/TestCE>)))
	(do-for-all-facts ((?fct TripleTemplate)) 
...
(defrule rule-gen7695 (declare (salience -1))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?arglist ))
		...
		(object ?constraintop))
		=>
(bind ?slotop (<http://white.gobo/new-blanknode>))(bind ?pattern (<http://white.gobo/new-blanknode>))(bind ?slotargs (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifatom)
...
(defrule rule-gen7708 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args>)
		(object ?arglist))
...
(defrule rule-gen7715 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args>)
		(object ?gen7718))	=>
...
(defrule rule-gen7720 (declare (salience -1))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen7739 (declare (salience -1))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
	...
	(not 	(TripleTemplate
		...
		=>
(bind ?pattern (<http://white.gobo/new-blanknode>))(bind ?slotpredicate (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldpatternlist ?trpl:object))(bind ?slotsubject (<http://white.gobo/new-blanknode>))(bind ?slotobject (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?pattern)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://clips.script/TemplatePatternCE>)))
	(assert 	(TripleTemplate
...
(defrule rule-gen7786 (declare (salience 50))
	(TripleTemplate
...
(defrule rule-gen7793 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen7827 (declare (salience -1))
	...
	(assert 	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://example.com/qwertz>)
		(object "10^^http://www.w3.org/2001/XMLSchema#integer")))

)

(defrule rule-gen7858 (declare (salience -1))
	(TripleTemplate
		(subject ?rifconstiristring)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object "http%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-predicate%23iri-string^^http://www.w3.org/2001/XMLSchema#anyURI"))
...
(defrule rule-gen7886 (declare (salience -1))
	(TripleTemplate
		(subject ?rifconstiristring)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object "http%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-predicate%23iri-string^^http://www.w3.org/2001/XMLSchema#anyURI"))
	...
	(assert 	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://example.com/qwertz>)
		(object "8^^http://www.w3.org/2001/XMLSchema#integer")))

)

(defrule rule-gen7911 (declare (salience -1))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#op>)
		(object ?rifconstiristring))
...
(defrule rule-gen7921 (declare (salience -1))
	(TripleTemplate
		(subject ?rifconstiristring)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object "http%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-predicate%23iri-string^^http://www.w3.org/2001/XMLSchema#anyURI"))
...
(defrule rule-gen7934 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen7944 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
