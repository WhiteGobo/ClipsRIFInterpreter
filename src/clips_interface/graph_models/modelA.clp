...
(defrule rule-gen16165 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16178 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16189 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16196 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16225 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16242 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(deffacts rule-gen16253
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen16254 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen16265 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
...
(defrule rule-gen16273 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16288 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16298 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16308 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16324 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
...
(defrule rule-gen16331 (declare (salience 10))
	(TripleTemplate
		(subject ?rifdocument)
...
(defrule rule-gen16341 (declare (salience 10))
	(TripleTemplate
		(subject ?supergroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16356 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16388 (declare (salience -100))
	(Member
		(instance ?rifnode)
...
(defrule rule-gen16397 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen16482 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen16495 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen16502 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen16520 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16528 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16534 (declare (salience 100))
	(TripleTemplate
		(subject ?clause)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?assert))
...
(defrule rule-gen16544 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16556 (declare (salience 100))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16564 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16574 (declare (salience 100))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16584 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen16617 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#if>)
		(object ?formula))
...
(defrule rule-gen16624 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16650 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16656 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16664 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16697 (declare (salience 100))
(or 	(Member
		(instance ?rifformula)
		(class <http://www.w3.org/2007/rif#Atom>))
		(Member
...
(defrule rule-gen16704 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16716 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16731 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16744 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16752 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16760 (declare (salience 100))
	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?action))	=>
...
(defrule rule-gen16764 (declare (salience 100))
(or 	(Member
		(instance ?action)
...
(defrule rule-gen16774 (declare (salience 100))
(or 	(Member
		(instance ?action)
		(class <http://www.w3.org/2007/rif#Assert>))
		(Member
...
(defrule rule-gen16783 (declare (salience 100))
	(Member
		(instance ?rifforall)
		(class <http://www.w3.org/2007/rif#Forall>))
		(TripleTemplate
...
(defrule rule-gen16793 (declare (salience 100))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen16826 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen16833 (declare (salience 80))
	(TripleTemplate
		(subject ?child)
...
(defrule rule-gen16837 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actions>)
		(object ?childlist))
...
(defrule rule-gen16852 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen16859 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen16874 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?arglist))
...
(defrule rule-gen16888 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#op>)
		(object ?child))
...
(defrule rule-gen16924 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen16938 (declare (salience 100))
	(TripleTemplate
		(subject ?rifnot)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23give-inheritance%3E)
		(object ?target))
...
(defrule rule-gen16950 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen16960 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen16976 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen16982 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?group))
...
(defrule rule-gen16997 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen17010 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen17023 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen17036 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen17085 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen17101 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen17207 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17238 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen17343 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17371 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen17518 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen17537 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen17546 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen17568 (declare (salience -1))
	(Atom
...
(defrule rule-gen17574 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen17588 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen17649 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen17653 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object ?iristring))
...
(defrule rule-gen17657 (declare (salience 60))
	(Member
		(instance ?rifdocument)
		(class <http://www.w3.org/2007/rif#Document>))
		(TripleTemplate
...
(defrule rule-gen17666 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17670 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen17676 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17685 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen17695 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen17699 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen17704 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen17727 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen17737 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen17755 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen17770 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen17788 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen17795 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen17802 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17806 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen17810 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen17831 (declare (salience 5))
	(Member
		(instance ?rifvar)
		(class <http://www.w3.org/2007/rif#Var>))
		(TripleTemplate
...
(defrule rule-gen17837 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://example.com/ConstraintGenerator>))
		(TripleTemplate
...
(defrule rule-gen17846 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen17863 (declare (salience 5))
	(Member
		(instance ?rifrule)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen17913 (declare (salience 5))
	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17922 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17949 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rifvar))
...
(defrule rule-gen18004 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18020 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18038 (declare (salience 5))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?arglist))
...
(defrule rule-gen18045 (declare (salience 5))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18062 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18071 (declare (salience 5))
	(Member
		(instance ?rifor)
		(class <http://www.w3.org/2007/rif#Or>))
		(TripleTemplate
...
(defrule rule-gen18082 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen18094 (declare (salience 5))
	(Member
		(instance ?rifequal)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18103 (declare (salience 5))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18112 (declare (salience 5))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifpattern))
...
(defrule rule-gen18160 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-constraint-needs-var%3E))
		(TripleTemplate
...
(defrule rule-gen18171 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-expression-needs-var%3E))
		(TripleTemplate
...
(defrule rule-gen18182 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-expression-needs-var%3E))
		(Member
...
(defrule rule-gen18190 (declare (salience 5))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen18198 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Or>))
		=>
...
(defrule rule-gen18201 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#INeg>))
		=>
...
(defrule rule-gen18204 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen18213 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen18227 (declare (salience 11))
	(Atom
...
(defrule rule-gen18241 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18254 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		=>
...
(defrule rule-gen18257 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
	(not(exists (and 	(TripleTemplate
...
(defrule rule-gen18271 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifformula%3E))
		(Member
...
(defrule rule-gen18283 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifobj)
		(predicate <http://www.w3.org/2007/rif#if>)
		(object ?formula))
...
(defrule rule-gen18293 (declare (salience 20))
	(TripleTemplate
		(subject ?rifand)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?otherrifand))
...
(defrule rule-gen18306 (declare (salience 20))
	(TripleTemplate
		(subject ?rifforall)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifrule))
...
(defrule rule-gen18323 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-false%3E)
		(args ))
		(Member
...
(defrule rule-gen18341 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen18369 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen18400 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen18429 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-after-conditions%3E)
		(object ?andpattern))
...
(defrule rule-gen18439 (declare (salience 5))
	(Member
...
(defrule rule-gen18448 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18473 (declare (salience 5))
	(Member
...
(defrule rule-gen18511 (declare (salience 5))
(or 	(Member
		(instance ?formulacontainer)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18524 (declare (salience 5))
(or 	(Member
		(instance ?rifnot)
		(class <http://www.w3.org/2007/rif#INeg>))
		(Member
...
(defrule rule-gen18544 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18557 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18567 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen18592 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18604 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18616 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18628 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18642 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18665 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18688 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18711 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18740 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen18757 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen18776 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifaction))
...
(defrule rule-gen18785 (declare (salience 5))
	(TripleTemplate
		(subject ?super)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?sub))
...
(defrule rule-gen18792 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?rifaction))
...
(defrule rule-gen18813 (declare (salience 5))
	(TripleTemplate
		(subject ?rifvar)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23use-expression-from%3E)
...
(defrule rule-gen18945 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen18952 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen18956 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
