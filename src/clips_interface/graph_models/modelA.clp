...
(defrule rule-gen3378 (declare (salience 10))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen3397 (declare (salience 10))
	(TripleTemplate
		(subject ?rule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
...
(defrule rule-gen3407 (declare (salience 10))
	(TripleTemplate
		(subject ?rule)
		(predicate <http://example.com/uses-action-from>)
		(object ?formula))
...
(defrule rule-gen3414 (declare (salience 10))
	(TripleTemplate
		(subject ?clipsrule)
...
(defrule rule-gen3421 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen3440 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen3464 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen3468 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3475 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3482 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen3489 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen3502 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen3518 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
