...
(defrule rule-gen3201 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen3205 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3212 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen3219 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen3226 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
...
(defrule rule-gen3239 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen3255 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen3283 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#numeric-greater-than> (<http://www.w3.org/2007/rif-builtin-function#count> ?slotlist ) "1^^http://www.w3.org/2001/XMLSchema#integer" ))
		=>
(bind ?newframefirst (<http://white.gobo/new-blanknode>))(bind ?newframerest (<http://white.gobo/new-blanknode>))	(do-for-all-facts ((?fct TripleTemplate)) (and (eq ?fct:subject ?rifforall) (and (eq ?fct:predicate <http://www.w3.org/2007/rif#pattern>)(eq ?fct:object ?rifframe)))
		(retract ?fct))	(assert 	(TripleTemplate
		(subject ?rifforall)
		(predicate <http://www.w3.org/2007/rif#pattern>)
...
(defrule rule-gen3293 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?slotsubject (<http://white.gobo/new-blanknode>))(bind ?slotpredicate (<http://white.gobo/new-blanknode>))(bind ?clipsnode (<http://white.gobo/new-blanknode>))(bind ?slotobject (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen3342 
	...
	(not 	(TripleTemplate
		...
		(object ?slot)))
		=>
(bind ?slotobject (<http://white.gobo/new-blanknode>))(bind ?clipsconditionalelement (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?rifnode) (eq ?trpl:predicate <http://example.com/in-as-conditional>))
		(bind ?existingconditionals ?trpl:object))(bind ?slotsubject (<http://white.gobo/new-blanknode>))(bind ?slotpredicate (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://example.com/used-slot-for-conditional>)
		(object ?slot)))
	(do-for-all-facts ((?fct TripleTemplate)) 
...
(defrule rule-gen3395 
	(TripleTemplate
		...
		(object ?varname))
		=>
(bind ?clipsretract (<http://white.gobo/new-blanknode>))(bind ?clipsdeftemplate (<http://white.gobo/new-blanknode>))(bind ?clipsexpand (<http://white.gobo/new-blanknode>))(bind ?factvariable (<http://white.gobo/new-blanknode>))(bind ?clipsfindfacts (<http://white.gobo/new-blanknode>))(bind ?factquery (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifretract)
		(predicate <http://example.com/as-action>)
	...
	(assert 	(TripleTemplate
		...
		(object (<http://www.w3.org/2007/rif-builtin-function#make-list> ?clipsdeftemplate ))))
	(assert 	(TripleTemplate
		(subject ?clipsfindfacts)
	...
	(assert 	(TripleTemplate
		(subject ?factquery)
		(predicate <http://clips.script/function-args>)
		(object (<http://www.w3.org/2007/rif-builtin-function#make-list> ?factvariable ?varname ))))

)

(defrule rule-gen3405 
	(TripleTemplate
		(subject ?rifretract)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Retract>))
		...
		(object <http://www.w3.org/2007/rif#Frame>))
		=>
(bind ?clipsexpand (<http://white.gobo/new-blanknode>))(bind ?clipsretract (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifretract)
		(predicate <http://example.com/as-action>)
		(object (<http://www.w3.org/2007/rif-builtin-function#make-list> ?clipsretract ))))
	(assert 	(TripleTemplate
...
(defrule rule-gen3468 (declare (salience 10))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen3487 (declare (salience 10))
	(TripleTemplate
		(subject ?rule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen3497 (declare (salience 10))
	(TripleTemplate
		(subject ?rule)
		(predicate <http://example.com/uses-action-from>)
		(object ?formula))
...
(defrule rule-gen3504 (declare (salience 10))
	(TripleTemplate
		(subject ?clipsrule)
...
(defrule rule-gen3511 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen3530 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
