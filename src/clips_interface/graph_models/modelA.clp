...
(defrule rule-gen16256 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
...
(defrule rule-gen16287 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen16320 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen16327 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen16334 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
...
(defrule rule-gen16342 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16348 (declare (salience 100))
	(TripleTemplate
		(subject ?clause)
...
(defrule rule-gen16358 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16370 (declare (salience 100))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16378 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16398 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen16431 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?rifimply)
...
(defrule rule-gen16438 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16464 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16470 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16478 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16511 (declare (salience 100))
(or 	(Member
		(instance ?rifformula)
		(class <http://www.w3.org/2007/rif#Atom>))
		(Member
...
(defrule rule-gen16545 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16558 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16578 (declare (salience 100))
(or 	(Member
		(instance ?action)
...
(defrule rule-gen16588 (declare (salience 100))
(or 	(Member
		(instance ?action)
		(class <http://www.w3.org/2007/rif#Assert>))
		(Member
...
(defrule rule-gen16597 (declare (salience 100))
	(Member
		(instance ?rifforall)
		(class <http://www.w3.org/2007/rif#Forall>))
		(TripleTemplate
...
(defrule rule-gen16607 (declare (salience 100))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen16640 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen16647 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen16719 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen16745 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen16755 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen16777 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
...
(defrule rule-gen16784 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen16792 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen16818 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen16831 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen16880 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen16896 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen16963 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16976 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16987 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16994 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17023 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen17032 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(defrule rule-gen17040 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(deffacts rule-gen17051
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen17052 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen17063 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentencelist))
...
(defrule rule-gen17086 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17096 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17106 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17122 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
...
(defrule rule-gen17129 (declare (salience 10))
	(TripleTemplate
		(subject ?rifdocument)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?rifgroup))
...
(defrule rule-gen17139 (declare (salience 10))
	(TripleTemplate
		(subject ?supergroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen17154 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen17264 
	...
	(or 	(Member
		...
		=>
(bind ?rightexpr (<http://white.gobo/new-blanknode>))(bind ?position (<http://white.gobo/new-blanknode>))(bind ?eq (<http://white.gobo/new-blanknode>))(bind ?leftexpr (<http://white.gobo/new-blanknode>))(bind ?testpattern (<http://white.gobo/new-blanknode>))	(assert 	(Member
...
(defrule rule-gen17326 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17330 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen17334 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen17355 (declare (salience 5))
	(Member
		(instance ?rifvar)
		(class <http://www.w3.org/2007/rif#Var>))
		(TripleTemplate
...
(defrule rule-gen17361 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://example.com/ConstraintGenerator>))
		(TripleTemplate
...
(defrule rule-gen17370 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen17387 (declare (salience 5))
	(Member
		(instance ?rifrule)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen17406 (declare (salience 5))
(or 	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
		(Member
...
(defrule rule-gen17437 (declare (salience 5))
	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17446 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17473 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rifvar))
...
(defrule rule-gen17482 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?itemlist))
...
(defrule rule-gen17491 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?rifvar))
...
(defrule rule-gen17528 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17544 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17562 (declare (salience 5))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?arglist))
...
(defrule rule-gen17569 (declare (salience 5))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen17586 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17595 (declare (salience 5))
	(Member
		(instance ?rifor)
		(class <http://www.w3.org/2007/rif#Or>))
		(TripleTemplate
...
(defrule rule-gen17606 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen17618 (declare (salience 5))
	(Member
		(instance ?x)
		(class <http://white.gobo/modelA#ConditionGenerator>))	=>
	(assert 	(Atom
...
(defrule rule-gen17621 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17633 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17648 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17660 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17681 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifvar ))
		(Member
...
(defrule rule-gen17689 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifterm ))
		(TripleTemplate
...
(defrule rule-gen17702 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifterm ))
		(TripleTemplate
...
(defrule rule-gen17718 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17727 (declare (salience 5))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen17735 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Or>))
		=>
...
(defrule rule-gen17738 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#INeg>))
		=>
...
(defrule rule-gen17741 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen17750 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen17764 (declare (salience 11))
	(Member
		(instance ?pattern)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(Member
...
(defrule rule-gen17777 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17790 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		=>
...
(defrule rule-gen17793 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
	(not(exists (and 	(TripleTemplate
...
(defrule rule-gen17807 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifformula%3E))
		(Member
...
(defrule rule-gen17829 (declare (salience 20))
	(TripleTemplate
		(subject ?rifand)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?otherrifand))
...
(defrule rule-gen17842 (declare (salience 20))
	(TripleTemplate
		(subject ?rifforall)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifrule))
...
(defrule rule-gen17859 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17876 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen17904 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen17935 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen17964 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-after-conditions%3E)
		(object ?andpattern))
...
(defrule rule-gen17974 (declare (salience 5))
	(Member
...
(defrule rule-gen17983 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18008 (declare (salience 5))
	(Member
...
(defrule rule-gen18022 (declare (salience 5))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen18039 (declare (salience 5))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-variable-binding%3E)
		(object ?formulacontainer))
...
(defrule rule-gen18046 (declare (salience 5))
(or 	(Member
		(instance ?formulacontainer)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18059 (declare (salience 5))
(or 	(Member
		(instance ?rifnot)
		(class <http://www.w3.org/2007/rif#INeg>))
		(Member
...
(defrule rule-gen18073 (declare (salience 5))
	(Member
		(instance ?riflist)
...
(defrule rule-gen18079 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18092 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18102 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen18127 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18139 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18151 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18163 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18200 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18226 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18252 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18284 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen18301 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen18320 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifaction))
...
(defrule rule-gen18329 (declare (salience 5))
	(TripleTemplate
		(subject ?super)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?sub))
...
(defrule rule-gen18336 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?rifaction))
...
(defrule rule-gen18344 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://white.gobo/modelA#as-defrule>)
		(object ?defrule))
...
(defrule rule-gen18357 (declare (salience 5))
	(TripleTemplate
		(subject ?rifvar)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23use-expression-from%3E)
...
(defrule rule-gen18399 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen18412 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen18455 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen18472 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
		(predicate <http://www.w3.org/2007/rif#constname>)
		(object ?name))
...
(defrule rule-gen18481 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen18490 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen18512 (declare (salience -1))
	(Atom
...
(defrule rule-gen18532 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen18610 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen18638 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen18765 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen18772 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen18776 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
...
(defrule rule-gen18834 (declare (salience -100))
	(Member
		(instance ?rifnode)
...
(defrule rule-gen18843 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen18928 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen18932 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen18938 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18957 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen18961 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen18966 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen18989 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen18999 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen19017 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen19032 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldpatternlist ?trpl:object))(bind ?testvaraction (<http://white.gobo/new-blanknode>))(bind ?assignpattern (<http://white.gobo/new-blanknode>))(bind ?tmplistasvar (<http://white.gobo/new-blanknode>))(bind ?testvarpattern (<http://white.gobo/new-blanknode>))	(assert 	(Member
