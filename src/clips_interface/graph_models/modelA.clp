...
(defrule rule1 (declare (salience 10))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifframe ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifframe ))
)
	=>
(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#triple-connected-to> ) (object  ?clipsvar ))))

(defrule rule2 (declare (salience -14))
...
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?itemvar ))
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://www.w3.org/2007/rif#content> ) (object  ?rifatom ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifexternal ))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifexternal ))
)
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?listvar ))
)
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#ListcontainerPatternGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifexternal )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?listvar ))) (do-for-all-facts (( ?fct14 TripleTemplate)) (and (eq ?fct14:subject   ?formulacontainer  )  (eq ?fct14:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct14  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifexternal  )))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-binds-var> ) (object  ?clipsconstraint ))
(or
...
(not
(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule5 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
 ?arglist  <- (AtomList (items  $?  ?rifexternal  $? ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifatom ))
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-constraint-needs-var> ))))

(defrule rule6 (declare (salience -1))
(or
...
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?x ))
	...
	=>
 (bind ?andpattern   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?andpattern ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-after-conditions> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct27 TripleTemplate)) (and (eq ?fct27:subject   ?formulacontainer  )  (eq ?fct27:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct27  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct13 TripleTemplate)) (and (eq ?fct13:subject   ?superpattern  )  (eq ?fct13:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct13  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?andpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer ))))

(defrule rule7 (declare (salience 11))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expressions-needs-var> ) (object  ?clipsvar ))))

(defrule rule8 (declare (salience -15))
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?rifmember ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifmember ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifmember ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct20 TripleTemplate)) (and (eq ?fct20:subject   ?formulacontainer  )  (eq ?fct20:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct20  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#MemberPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(defrule rule10 (declare (salience 5))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-binds-var> ) (object  ?clipsconstraint ))
	=>
(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-binds-var> ) (object  ?clipsconstraint ))))

(defrule rule11 (declare (salience 20))
(or
...
(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifrule ))
(or
...
(Member (class  <http://www.w3.org/2007/rif#Forall> ) (instance  ?rifforall ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifrule )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifformula ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifframe ))
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?slot ))))

(defrule rule13 (declare (salience 11))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
...
(TripleTemplate (subject  ?formula ) (predicate  <http://www.w3.org/2007/rif#vars> ) (object  ?varlist ))
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#subpattern-needs-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-needs-var> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule15 (declare (salience -11))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifframe ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?slot ))
...
(and
(or
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#triple-connected-to> ) (object  ?x ))
(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#triple-connected-to> ) (object  ?x ))
)
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
...
(exists
(and
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
...
(exists
(and
(TripleTemplate (subject  ?frameobject ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?slot ))
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?slot )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifframe ))) (do-for-all-facts (( ?fct22 TripleTemplate)) (and (eq ?fct22:subject   ?formulacontainer  )  (eq ?fct22:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct22  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?slot  ))))(assert(Member (instance  ?slot ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer )))(assert(Member (instance  ?rifframe ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(defrule rule17 (declare (salience -21))
...
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct11 TripleTemplate)) (and (eq ?fct11:subject   ?formulacontainer  )  (eq ?fct11:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct11  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#SubclassPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule18 (declare (salience 5))
(Member (class  <http://white.gobo/local/b/n18ad1320_n11298#check-constraint-needs-var> ) (instance  ?rifterm ))
(TripleTemplate (subject  ?rifterm ) (predicate  <http://example.com/inherits-data> ) (object  ?rifvar ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-needs-var> ) (object  ?clipsvar ))))

(defrule rule19 (declare (salience -1))
(or
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?superpattern ))
)
...
(Member (class  <http://clips.script/NotCE> ) (instance  ?superpattern ))
	...
	=>
 (do-for-all-facts (( ?fct24 TripleTemplate)) (and (eq ?fct24:subject   ?formulacontainer  )  (eq ?fct24:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct24  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct19 TripleTemplate)) (and (eq ?fct19:subject   ?superpattern  )  (eq ?fct19:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct19  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(TripleTemplate (subject  ?group ) (predicate  <http://www.w3.org/2007/rif#sentences> ) (object  ?sentences ))
	=>
 (bind ?defrule   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?defrule )))(assert(Member (instance  ?defrule ) (class  <http://clips.script/Defrule> )))(assert(TripleTemplate (subject  ?defrule ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-binds-var> ) (object  ?clipsconstraint ))
(not
(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?subpattern ))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subpattern ))
)
(not
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?subsub ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subsub ))
)
)
)
)
...
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#subpattern-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct23 TripleTemplate)) (and (eq ?fct23:subject   ?superpattern  )  (eq ?fct23:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct23  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))

(defrule rule23 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?formula ))
	=>
 (bind ?clipsnot   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsnot )))(assert(Member (instance  ?clipsnot ) (class  <http://clips.script/NotCE> )))(assert(TripleTemplate (subject  ?clipsnot ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule24 (declare (salience -23))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifequal ))
...
(exists
(and
(TripleTemplate (subject  ?rifright ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifequal ))
)
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsassign ))
)
	=>
(assert(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsassign )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifequal )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#TestPatternLeftAssignGenerator> )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#PatternGenerator> )))(assert(Member (instance  ?rifright ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsassign ))))

(defrule rule25 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#use-expression-from> ) (object  ?rifexpression ))
...
(defrule rule26 (declare (salience -7))
(or
...
(exists
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?x ))
)
(not
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct12 TripleTemplate)) (and (eq ?fct12:subject   ?superpattern  )  (eq ?fct12:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct12  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))
...
(exists
(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?x ))
)
	=>
(assert(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?formula ))))
...
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?rifnot ) (predicate  <http://www.w3.org/2007/rif#formula> ) (object  ?rifformula ))
(not
(exists
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subpattern ))
)
)
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))))

(defrule rule29 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?formula ))
	=>
 (bind ?clipsexists   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsexists )))(assert(Member (instance  ?clipsexists ) (class  <http://clips.script/ExistsCE> )))(assert(TripleTemplate (subject  ?clipsexists ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule30 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifand ))
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subformula ))
...
(exists
(and
(Member (class  <http://white.gobo/local/b/n18ad1320_n11298#rifformula> ) (instance  ?otherformula ))
...
(defrule rule32 (declare (salience -23))
...
(exists
(and
(TripleTemplate (subject  ?rifleft ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?rifvar  ))
	...
	=>
(assert(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?clipsvar ))))
...
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?formula ))
	...
	=>
(assert(Member (instance  ?formula ) (class  <http://white.gobo/local/b/n18ad1320_n11298#rifformula> ))))

(defrule rule35 (declare (salience 20))
(or
...
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?otherrifand ))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?formulalist   ?rifformula  ))
	...
	=>
(assert(TripleTemplate (subject  ?otherrifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?otherrifand )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifformula ))))

(defrule rule36 (declare (salience 5))
(Member (class  <http://white.gobo/local/b/n18ad1320_n11298#check-expression-needs-var> ) (instance  ?rifterm ))
...
(TripleTemplate (subject  ?rifterm ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?clipsvar ))))

(defrule rule37 (declare (salience 11))
...
(Atom (op  <http://white.gobo/local/b/n18ad1320_n11298#always-false> ) (args ))
	=>
(assert(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?clipsvar ))))

(defrule rule38 (declare (salience 10))
(or
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifframe ))
	...
	=>
(assert(TripleTemplate (subject  ?rifslot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#triple-connected-to> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?superimply ) (predicate  <http://www.w3.org/2007/rif#if> ) (object  ?rifand ))
	...
	=>
 (bind ?clipsand   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsand )))(assert(Member (instance  ?clipsand ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?clipsand ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule40 (declare (salience -21))
...
(exists
(and
(TripleTemplate (subject  ?targetstring ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
...
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsassign ))
)
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#AssignGenerator> )))(assert(TripleTemplate (subject  ?targetiri ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#use-expression-from> ) (object  ?targetstring )))(assert(Member (instance  ?targetstring ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifexternal )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?targetstring ))))

(defrule rule41 (declare (salience -1))
(or
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?superpattern ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
)
...
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?aftercondition ))
	...
	=>
 (do-for-all-facts (( ?fct26 TripleTemplate)) (and (eq ?fct26:subject   ?formulacontainer  )  (eq ?fct26:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct26  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct25 TripleTemplate)) (and (eq ?fct25:subject   ?superpattern  )  (eq ?fct25:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct25  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifequal ))) (do-for-all-facts (( ?fct15 TripleTemplate)) (and (eq ?fct15:subject   ?formulacontainer  )  (eq ?fct15:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct15  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifequal  ))))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#TestPatternEqualGenerator> )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#PatternGenerator> )))(assert(Member (instance  ?rifleft ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(Member (instance  ?rifright ) (class  <http://white.gobo/modelA#ExpressionGenerator> ))))

(defrule rule43 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Or> ) (instance  ?formula ))
	=>
 (bind ?clipsor   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsor )))(assert(Member (instance  ?clipsor ) (class  <http://clips.script/OrCE> )))(assert(TripleTemplate (subject  ?clipsor ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule44 (declare (salience -5))
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?rifmember ))
(exists
(and
(or
...
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifmember ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct16 TripleTemplate)) (and (eq ?fct16:subject   ?formulacontainer  )  (eq ?fct16:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct16  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#MemberPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule45 (declare (salience 11))
...
(TripleTemplate (subject  ?rifvarconsumer ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifineg ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#subpattern-needs-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rifequal ) (predicate  <http://www.w3.org/2007/rif#left> ) (object  ?left ))
	=>
(assert(Member (instance  ?left ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-expression-needs-var> )))(assert(Member (instance  ?right ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-expression-needs-var> ))))

(defrule rule48 (declare (salience -1))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-after-conditions> ) (object  ?andpattern ))
(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  ?conditions ))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?aftercondition ))
(not
(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transferred-after-condition> ) (object  ?andpattern ))
)
	=>
(assert(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transferred-after-condition> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct18 TripleTemplate)) (and (eq ?fct18:subject   ?andpattern  )  (eq ?fct18:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct18  ) ) (assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?conditions   ?aftercondition  )))))

(defrule rule49 (declare (salience 5))
(or
...
(defrule rule50 (declare (salience 5))
(or
...
(exists
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?x ))
)
	=>
(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?formula ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?itemlist   ?rifvar  ))
	...
	=>
(assert(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraint-binds-var> ) (object  ?clipsconstraint ))))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifpattern ))
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-constraint-needs-var> ))))
...
(TripleTemplate (subject  ?rifconstiristring ) (predicate  <http://www.w3.org/2007/rif#constIRI> ) (object  "http%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-predicate%23iri-string^^http://www.w3.org/2001/XMLSchema#anyURI" ))
	=>
(assert(Member (instance  ?targetiri ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-expression-needs-var> )))(assert(Member (instance  ?targetstring ) (class  <http://white.gobo/local/b/n18ad1320_n11298#check-expression-needs-var> ))))
...
(exists
(and
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expressions-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifexternal ))) (do-for-all-facts (( ?fct21 TripleTemplate)) (and (eq ?fct21:subject   ?formulacontainer  )  (eq ?fct21:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct21  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifexternal  ))))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#TestPatternExternalGenerator> )))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule55 (declare (salience 5))
...
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))))
...
(defrule rule59 (declare (salience -100))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
...
(Member (class  <http://white.gobo/modelA#ConstraintGenerator> ) (instance  ?riflist ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?unboundvar ))
(not
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?unboundvar ))
)
	=>
...
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?subformula ))
(not
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?subformula ))
)
	=>
(assert(TripleTemplate (subject  ?subformula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?pattern ))
(not
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?pattern ))
)
	=>
...
(not
(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(defrule rule67 (declare (salience -21))
(Member (class  <http://www.w3.org/2007/rif#Atom> ) (instance  ?rifatom ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?rifatom ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  ?formulalist ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifatom ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifatom ))) (do-for-all-facts (( ?fct28 TripleTemplate)) (and (eq ?fct28:subject   ?formulacontainer  )  (eq ?fct28:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct28  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifatom  ))))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#AtomPatternGenerator> )))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(TripleTemplate (subject  ?arg ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#expression-needs-var> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule69 (declare (salience -21))
(Member (class  <http://www.w3.org/2007/rif#Slot> ) (instance  ?slot ))
(TripleTemplate (subject  ?slot ) (predicate  <http://www.w3.org/2007/rif#slotkey> ) (object  ?slotkey ))
(TripleTemplate (subject  ?slot ) (predicate  <http://www.w3.org/2007/rif#slotvalue> ) (object  ?slotvalue ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?slot ))
...
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?slot )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?rifframe ))) (do-for-all-facts (( ?fct17 TripleTemplate)) (and (eq ?fct17:subject   ?formulacontainer  )  (eq ?fct17:predicate   <http://white.gobo/local/b/n18ad1320_n11298#formulalist>  ) ) (retract ?fct17  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?slot  ))))(assert(Member (instance  ?slot ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer )))(assert(Member (instance  ?rifframe ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#add-pattern-from> ) (object  ?formula ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#added-pattern-from> ) (object  ?formula ))
)
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n18ad1320_n11298#bound-variable> ) (object  ?clipsvar ))))
...
(defrule rule72 (declare (salience -1))
...
(defrule rule73 (declare (salience -102))
...
(defrule rule74 (declare (salience -1))
...
(defrule rule75 (declare (salience 60))
...
(defrule rule79 (declare (salience -102))
...
(defrule rule80 (declare (salience -1))
...
(defrule rule92 (declare (salience 10))
...
(defrule rule98 (declare (salience -100))
...
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-additional-patterns-to> ) (object  ?multipattern ))
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-item-from> ) (object  ?rifitems ))
(test (eq ?item   (<http://www.w3.org/2007/rif-builtin-function#get> ?rifitems   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))

	=>
 (do-for-all-facts (( ?fct38 TripleTemplate)) (and (eq ?fct38:subject   ?items  )  (eq ?fct38:predicate   <http://white.gobo/local/b/n18ad1320_n6019#add-item-from>  ) ) (retract ?fct38  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-item-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifitems   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct37 TripleTemplate)) (and (eq ?fct37:subject   ?items  )  (eq ?fct37:predicate   <http://clips.script/constraints>  ) ) (retract ?fct37  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?term  ))))(assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-list> ) (object  ?item ))))
...
(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  ?oldlist ))
	=>
 (do-for-all-facts (( ?fct34 TripleTemplate)) (and (eq ?fct34:subject   ?items  )  (eq ?fct34:predicate   <http://white.gobo/local/b/n18ad1320_n6019#add-item-from>  ) ) (retract ?fct34  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-item-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifitems   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct35 TripleTemplate)) (and (eq ?fct35:subject   ?items  )  (eq ?fct35:predicate   <http://clips.script/constraints>  ) ) (retract ?fct35  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?term  )))))
...
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#use-items-from> ) (object  ?list ))
(not
(Member (class  <http://white.gobo/local/b/n18ad1320_n6019#OpenList> ) (instance  ?items ))
)
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-item-from> ) (object  ?rifitems ))
...
(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  ?oldlist ))
	=>
 (bind ?anyslots   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#added-rest> ) (object  ?rest )))(assert(Member (instance  ?anyslots ) (class  <http://clips.script/MultifieldVariable> )))(assert(TripleTemplate (subject  ?anyslots ) (predicate  <http://clips.script/variable-name> ) (object  "" ))) (do-for-all-facts (( ?fct36 TripleTemplate)) (and (eq ?fct36:subject   ?items  )  (eq ?fct36:predicate   <http://clips.script/constraints>  ) ) (retract ?fct36  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?anyslots  ))))(assert(Member (instance  ?items ) (class  <http://white.gobo/local/b/n18ad1320_n6019#OpenList> ))))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#items> ) (object  ?itemlist ))
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-list> ) (object  ?riflist ))
...
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-list> ) (object  ?list ))
(TripleTemplate (subject  ?list ) (predicate  <http://example.com/as-constraint> ) (object  ?listvar ))
(not
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#added-list> ) (object  ?list ))
)
	=>
 (bind ?checkvar   (<http://white.gobo/new-blanknode>) ) (bind ?pattern   (<http://white.gobo/new-blanknode>) ) (bind ?oldlist   (do-for-fact (( ?fct4 TripleTemplate)) (and (eq ?fct4:subject   ?multipattern  )  (eq ?fct4:predicate   <http://clips.script/conditional-element>  ) ) (fact-slot-value ?fct4   object  ) )  ) (bind ?check   (<http://white.gobo/new-blanknode>) ) (bind ?items   (<http://white.gobo/new-blanknode>) ) (bind ?assign   (<http://white.gobo/new-blanknode>) ) (bind ?checkfunction   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?checkvar ) (class  <http://example.com/Variable> )))(assert(Member (instance  ?checkvar ) (class  <http://clips.script/Variable> )))(assert(Member (instance  ?assign ) (class  <http://clips.script/AssignedPatternCE> )))(assert(TripleTemplate (subject  ?assign ) (predicate  <http://clips.script/fact-var-symbol> ) (object  ?checkvar )))(assert(TripleTemplate (subject  ?assign ) (predicate  <http://clips.script/pattern-ce> ) (object  ?pattern )))(assert(Member (instance  ?pattern ) (class  <http://clips.script/TemplatePatternCE> )))(assert(TripleTemplate (subject  ?pattern ) (predicate  <http://clips.script/deftemplate-name> ) (object  "AtomList" )))(assert(TripleTemplate (subject  ?pattern ) (predicate  <http://clips.script/slot> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?items  ))))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-additional-patterns-to> ) (object  ?multipattern )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/slot-name> ) (object  "items" )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-item-from> ) (object  ?rifitems )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#use-items-from> ) (object  ?list )))(assert(Member (instance  ?check ) (class  <http://clips.script/TestCE> )))(assert(TripleTemplate (subject  ?check ) (predicate  <http://clips.script/function-call> ) (object  ?checkfunction )))(assert(TripleTemplate (subject  ?checkfunction ) (predicate  <http://clips.script/function-name> ) (object  "eq" )))(assert(TripleTemplate (subject  ?checkfunction ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?checkvar   ?listvar  )))) (do-for-all-facts (( ?fct39 TripleTemplate)) (and (eq ?fct39:subject   ?multipattern  )  (eq ?fct39:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct39  ) ) (assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?assign   ?check  ))))(assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#added-list> ) (object  ?list ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?list  ))
	...
	=>
(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-list> ) (object  ?list ))))
...
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?list ))
	=>
 (bind ?andpattern   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-multi-lhs-pattern> ) (object  ?andpattern )))(assert(Member (instance  ?andpattern ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?formulapattern  ))))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://white.gobo/local/b/n18ad1320_n6019#add-list> ) (object  ?list ))))
...
(TripleTemplate (subject  ?functionsymbol ) (predicate  <http://clips.script/symbol> ) (object  ?functionname ))
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifexecute ) (predicate  <http://example.com/as-action> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?function  ))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  ?functionname )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5331#add-args-from> ) (object  ?rifarglist ))))

(defrule rule113 (declare (salience 15))
(TripleTemplate (subject  ?firstarg ) (predicate  <http://example.com/as-expression> ) (object  ?clipsexpression ))
(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5331#add-args-from> ) (object  ?rifarglist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?rifarglist  ))

(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))

	=>
 (bind ?functionargs   (do-for-fact (( ?fct5 TripleTemplate)) (and (eq ?fct5:subject   ?function  )  (eq ?fct5:predicate   <http://clips.script/function-args>  ) ) (fact-slot-value ?fct5   object  ) )  ) (do-for-all-facts (( ?fct41 TripleTemplate)) (and (eq ?fct41:subject   ?function  )  (eq ?fct41:predicate   <http://clips.script/function-args>  ) ) (retract ?fct41  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?functionargs   ?clipsexpression  )))) (do-for-all-facts (( ?fct40 TripleTemplate)) (and (eq ?fct40:subject   ?function  )  (eq ?fct40:predicate   <http://white.gobo/local/b/n18ad1320_n5331#add-args-from>  ) ) (retract ?fct40  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5331#add-args-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(defrule rule116 (declare (salience 10))
(Member (class  <http://white.gobo/modelA#ConstraintGenerator> ) (instance  ?riflist ))
...
(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from> ) (object  ?itemlist ))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (do-for-all-facts (( ?fct46 TripleTemplate)) (and (eq ?fct46:subject   ?function  )  (eq ?fct46:predicate   <http://clips.script/function-args>  ) ) (retract ?fct46  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?currentexprlist   ?firstasexpression  )))) (do-for-all-facts (( ?fct47 TripleTemplate)) (and (eq ?fct47:subject   ?function  )  (eq ?fct47:predicate   <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from>  ) ) (retract ?fct47  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#rest> ) (object  ?rest ))
	...
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/as-expression> ) (object  ?function )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  "%3Chttp%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-function%23make-list%3E" )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from> ) (object  ?itemlist ))))
...
(TripleTemplate (subject  ?slotitems ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-constraints-from> ) (object  ?itemlist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#numeric-greater-than> (<http://www.w3.org/2007/rif-builtin-function#count> ?itemlist  )  "0^^http://www.w3.org/2001/XMLSchema#integer"  ))
...
(TripleTemplate (subject  ?slotitems ) (predicate  <http://clips.script/constraints> ) (object  ?listconstraints ))
	=>
 (do-for-all-facts (( ?fct43 TripleTemplate)) (and (eq ?fct43:subject   ?slotitems  )  (eq ?fct43:predicate   <http://clips.script/constraints>  ) ) (retract ?fct43  ) ) (assert(TripleTemplate (subject  ?slotitems ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?listconstraints   ?clipsconstraint  )))) (do-for-all-facts (( ?fct44 TripleTemplate)) (and (eq ?fct44:subject   ?slotitems  )  (eq ?fct44:predicate   <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-constraints-from>  ) ) (retract ?fct44  ) ) (assert(TripleTemplate (subject  ?slotitems ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-constraints-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(test (eq "0^^http://www.w3.org/2001/XMLSchema#integer"   (<http://www.w3.org/2007/rif-builtin-function#count> ?itemlist  ) ))
	...
	=>
 (retract(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from> ) (object  ?itemlist ))) ))

(defrule rule121 (declare (salience -1))
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?riflist ))
...
(TripleTemplate (subject  ?defrule ) (predicate  <http://example.com/bound-variable> ) (object  ?x ))
	...
	=>
 (bind ?oldpatternlist   (do-for-fact (( ?fct6 TripleTemplate)) (and (eq ?fct6:subject   ?defrule  )  (eq ?fct6:predicate   <http://clips.script/conditional-element>  ) ) (fact-slot-value ?fct6   object  ) )  ) (bind ?assignpattern   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/used-as-pattern-in> ) (object  ?defrule )))(assert(Member (instance  ?assignpattern ) (class  <http://clips.script/AssignedPatternCE> )))(assert(TripleTemplate (subject  ?assignpattern ) (predicate  <http://clips.script/pattern-ce> ) (object  ?pattern )))(assert(TripleTemplate (subject  ?assignpattern ) (predicate  <http://clips.script/fact-var-symbol> ) (object  ?listasvar ))) (do-for-all-facts (( ?fct45 TripleTemplate)) (and (eq ?fct45:subject   ?defrule  )  (eq ?fct45:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct45  ) ) (assert(TripleTemplate (subject  ?defrule ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldpatternlist   ?assignpattern  ))))(assert(TripleTemplate (subject  ?defrule ) (predicate  <http://example.com/transfer-bound-variables-from> ) (object  ?pattern ))))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/add-as-pattern> ) (object  ?defrule ))
(Atom (op  <http://white.gobo/local/b/n18ad1320_n5194#combine-multifield-as-list> ) (args  ?rest  ?multifieldvar ))
(not
...
(defrule rule125 (declare (salience -100))
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n18ad1320_n5194#add-args-as-expression-from> ) (object  ?arglist ))
...
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#bound-variable> ) (object  ?assign ))
	=>
 (bind ?position   (<http://white.gobo/new-blanknode>) ) (bind ?testpattern   (<http://white.gobo/new-blanknode>) ) (bind ?function   (<http://white.gobo/new-blanknode>) ) (bind ?eq   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?testpattern ) (class  <http://clips.script/TestCE> )))(assert(TripleTemplate (subject  ?testpattern ) (predicate  <http://clips.script/function-call> ) (object  ?eq )))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?testpattern )))(assert(TripleTemplate (subject  ?eq ) (predicate  <http://clips.script/function-name> ) (object  "eq" )))(assert(TripleTemplate (subject  ?eq ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?assign   ?function  ))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  "%3Chttp%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-function%23sublist%3E" )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?listvar   ?position  ))))(assert(TripleTemplate (subject  ?position ) (predicate  <http://clips.script/string> ) (object  (<http://white.gobo/literal-to-clipsconstant> (<http://www.w3.org/2007/rif-builtin-function#count> ?itemlist  ) )))))

(defrule rule127 (declare (salience 10))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?targetlist ))
(TripleTemplate (subject  ?targetlist ) (predicate  <http://example.com/as-expression> ) (object  ?listvar ))
...
(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n18ad1320_n4228#add-atom-args-as-constraint> ) (object  ?arglist ))
(TripleTemplate (subject  ?firstarg ) (predicate  <http://example.com/as-constraint> ) (object  ?clipsexpr ))
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))

	=>
 (bind ?oldconstraints   (do-for-fact (( ?fct8 TripleTemplate)) (and (eq ?fct8:subject   ?slotargs  )  (eq ?fct8:predicate   <http://clips.script/constraints>  ) ) (fact-slot-value ?fct8   object  ) )  ) (do-for-all-facts (( ?fct49 TripleTemplate)) (and (eq ?fct49:subject   ?slotargs  )  (eq ?fct49:predicate   <http://white.gobo/local/b/n18ad1320_n4228#add-atom-args-as-constraint>  ) ) (retract ?fct49  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n18ad1320_n4228#add-atom-args-as-constraint> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct48 TripleTemplate)) (and (eq ?fct48:subject   ?slotargs  )  (eq ?fct48:predicate   <http://clips.script/constraints>  ) ) (retract ?fct48  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldconstraints   ?clipsexpr  )))))
...
(not
(Atom (op  <http://white.gobo/local/b/n18ad1320_n3246#processed-actionvar> ) (args  ?rifnode  ?actionvar ))
)
)
)
	=>
...
(TripleTemplate (subject  ?document ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?localconst ))
	=>
...
(TripleTemplate (subject  ?child ) (predicate  <http://www.w3.org/2007/rif#constname> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?child ))))
...
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?grandchild ))
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?grandchild ))))
...
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))
 ?childlist  <- (AtomList (items  $?  ?child  $? ))
(TripleTemplate (subject  ?rifdo ) (predicate  <http://www.w3.org/2007/rif#actions> ) (object  ?childlist ))
	=>
(assert(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#rifdoinheritance> ) (object  ?rifdo ))))

(defrule rule156 (declare (salience 100))
(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#rifdoinheritance> ) (object  ?parent ))
(not
(exists
(and
...
(test (eq ?var   (<http://www.w3.org/2007/rif-builtin-function#get> ?actionvar   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))))

(defrule rule157 (declare (salience 80))
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))
	=>
 (retract(assert(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))) ))
...
(TripleTemplate (subject  ?group ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?localconst ))
	=>
(assert(TripleTemplate (subject  ?document ) (predicate  <http://example.com/inherits-data> ) (object  ?localconst ))))
...
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))
(or
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?rifnot ))
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?rifnot ))
...
(TripleTemplate (subject  ?rifconstraint ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))
(or
...
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifformula ))
(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n18ad1320_n2557#give-inheritance> ) (object  ?target ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?target ))
	=>
...
(defrule rule200 (declare (salience -50))
...
(defrule rule203 (declare (salience 15))
(TripleTemplate (subject  ?function ) (predicate  <http://example.com/add-args-from> ) (object  ?rifarglist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?rifarglist  ))
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#priority> ) (object  "0^^http://www.w3.org/2001/XMLSchema#integer" ))))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://www.w3.org/2007/rif#then> ) (object  ?rifaction ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#add-as-action> ) (object  ?rifaction ))))
...
(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#priority> ) (object  ?priority ))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#add-as-action> ) (object  ?rifaction ))
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?priority ))
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#priority> ) (object  ?priority ))))
...
(TripleTemplate (subject  ?supergroup ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#priority> ) (object  ?priority ))
	=>
(assert(TripleTemplate (subject  ?subgroup ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#priority> ) (object  ?priority ))))

(defrule rule222 (declare (salience 10))
(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#add-as-action> ) (object  ?sub ))
(TripleTemplate (subject  ?sub ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#add-as-action> ) (object  ?rifaction ))
	=>
(assert(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n18ad1320_n683#add-as-action> ) (object  ?rifaction ))))

(deffacts facts7656d400
(Atom (op  <http://example.com/currentfactindex> ) (args  "1^^http://www.w3.org/2001/XMLSchema#integer" ))
)

(deffacts facts7ec97f00
