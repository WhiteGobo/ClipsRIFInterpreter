...
(defrule rule-gen17421 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
...
(do-for-fact ((?trpl TripleTemplate))
		...
		(bind ?oldpatternlist ?trpl:object))(bind ?slotcls (<http://white.gobo/new-blanknode>))(bind ?slotinstance (<http://white.gobo/new-blanknode>))(bind ?pattern (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?slot)
		(predicate <http://example.com/used-as-pattern-in>)
		(object ?defrule)))
	(assert 	(TripleTemplate
...
(defrule rule-gen17452 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen17485 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen17492 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen17499 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
...
(defrule rule-gen17507 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen17513 (declare (salience 100))
	(TripleTemplate
		(subject ?clause)
...
(defrule rule-gen17523 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen17535 (declare (salience 100))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17543 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17553 (declare (salience 100))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17596 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?rifimply)
...
(defrule rule-gen17603 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17629 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17635 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17643 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen17676 (declare (salience 100))
(or 	(Member
		(instance ?rifformula)
		(class <http://www.w3.org/2007/rif#Atom>))
		(Member
...
(defrule rule-gen17710 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen17731 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen17739 (declare (salience 100))
	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?action))	=>
...
(defrule rule-gen17743 (declare (salience 100))
(or 	(Member
		(instance ?action)
...
(defrule rule-gen17753 (declare (salience 100))
(or 	(Member
		(instance ?action)
		(class <http://www.w3.org/2007/rif#Assert>))
		(Member
...
(defrule rule-gen17762 (declare (salience 100))
	(Member
		(instance ?rifforall)
		(class <http://www.w3.org/2007/rif#Forall>))
		(TripleTemplate
...
(defrule rule-gen17772 (declare (salience 100))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17859 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen17872 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen17883 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen17919 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen17928 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(defrule rule-gen17936 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(deffacts rule-gen17947
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen17948 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen17959 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentencelist))
...
(defrule rule-gen17967 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17982 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17992 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen18002 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen18018 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
...
(defrule rule-gen18025 (declare (salience 10))
	(TripleTemplate
		(subject ?rifdocument)
...
(defrule rule-gen18035 (declare (salience 10))
	(TripleTemplate
		(subject ?supergroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen18050 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen18082 
	...
	(not 	(TripleTemplate
		...
		(object ?list)))
		=>
(bind ?checkfunction (<http://white.gobo/new-blanknode>))(bind ?assign (<http://white.gobo/new-blanknode>))(bind ?checkvar (<http://white.gobo/new-blanknode>))(bind ?check (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?multipattern) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldlist ?trpl:object))(bind ?pattern (<http://white.gobo/new-blanknode>))(bind ?items (<http://white.gobo/new-blanknode>))	(assert 	(Member
		(instance ?checkvar)
...
(defrule rule-gen18138 
	...
	(not	(Member
		...
		(class <http://white.gobo/modelA#VarAsConstExpr>)))
		=>
(bind ?function (<http://white.gobo/new-blanknode>))(bind ?position (<http://white.gobo/new-blanknode>))	(assert 	(Member
		(instance ?clipsvar)
		(class <http://white.gobo/modelA#VarAsConstExpr>)))
	(assert 	(TripleTemplate
		(subject ?clipsvar)
...
(defrule rule-gen18160 
	...
	(or 	(Member
		...
		=>
(bind ?position (<http://white.gobo/new-blanknode>))(bind ?leftexpr (<http://white.gobo/new-blanknode>))(bind ?testpattern (<http://white.gobo/new-blanknode>))(bind ?eq (<http://white.gobo/new-blanknode>))(bind ?rightexpr (<http://white.gobo/new-blanknode>))	(assert 	(Member
...
(defrule rule-gen18222 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen18229 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen18236 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18251 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?arglist))
...
(defrule rule-gen18301 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen18315 (declare (salience 100))
	(TripleTemplate
		(subject ?rifnot)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23give-inheritance%3E)
		(object ?target))
...
(defrule rule-gen18327 (declare (salience 100))
	(TripleTemplate
...
(defrule rule-gen18337 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen18353 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen18359 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?group))
...
(defrule rule-gen18366 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen18374 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen18387 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18400 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen18413 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen18462 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen18478 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen18491 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
		(subject ?rifforall)
		(predicate <http://www.w3.org/2007/rif#vars>)
...
(defrule rule-gen18498 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
	(or 	(TripleTemplate
...
(defrule rule-gen18554 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen18576 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen18583 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen18597 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen18611 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
	(or 	(TripleTemplate
...
(defrule rule-gen18676 (declare (salience 100))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen18690 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen18694 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen18698 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18719 (declare (salience 5))
	(Member
		(instance ?rifvar)
		(class <http://www.w3.org/2007/rif#Var>))
		(TripleTemplate
...
(defrule rule-gen18725 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://example.com/ConstraintGenerator>))
		(TripleTemplate
...
(defrule rule-gen18734 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen18751 (declare (salience 5))
	(Member
		(instance ?rifrule)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen18770 (declare (salience 5))
(or 	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
		(Member
...
(defrule rule-gen18801 (declare (salience 5))
	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18810 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen18837 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rifvar))
...
(defrule rule-gen18846 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?itemlist))
...
(defrule rule-gen18855 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?rifvar))
...
(defrule rule-gen18892 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18908 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18926 (declare (salience 5))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?arglist))
...
(defrule rule-gen18933 (declare (salience 5))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18950 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18959 (declare (salience 5))
	(Member
		(instance ?rifor)
		(class <http://www.w3.org/2007/rif#Or>))
		(TripleTemplate
...
(defrule rule-gen18970 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen18982 (declare (salience 5))
	(Member
		(instance ?x)
		(class <http://white.gobo/modelA#ConditionGenerator>))	=>
	(assert 	(Atom
...
(defrule rule-gen18985 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18997 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen19012 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen19024 (declare (salience 5))
	(Member
		(instance ?parent)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen19045 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifvar ))
		(Member
...
(defrule rule-gen19053 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifterm ))
		(TripleTemplate
...
(defrule rule-gen19066 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-binding%3E)
		(args ?rifterm ))
		(TripleTemplate
...
(defrule rule-gen19082 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen19091 (declare (salience 5))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen19099 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Or>))
		=>
...
(defrule rule-gen19102 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#INeg>))
		=>
...
(defrule rule-gen19105 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen19114 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen19128 (declare (salience 11))
	(Member
		(instance ?pattern)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(Member
...
(defrule rule-gen19141 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen19154 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		=>
...
(defrule rule-gen19157 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
	(not(exists (and 	(TripleTemplate
...
(defrule rule-gen19171 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifformula%3E))
		(Member
...
(defrule rule-gen19183 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifobj)
		(predicate <http://www.w3.org/2007/rif#if>)
		(object ?formula))
...
(defrule rule-gen19193 (declare (salience 20))
	(TripleTemplate
		(subject ?rifand)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?otherrifand))
...
(defrule rule-gen19206 (declare (salience 20))
	(TripleTemplate
		(subject ?rifforall)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifrule))
...
(defrule rule-gen19223 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen19240 (declare (salience 5))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(Member
...
(defrule rule-gen19254 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen19282 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen19313 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen19342 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-after-conditions%3E)
		(object ?andpattern))
...
(defrule rule-gen19352 (declare (salience 5))
	(Member
...
(defrule rule-gen19361 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen19372 (declare (salience 5))
	(Member
		(instance ?rifmember)
		(class <http://white.gobo/modelA#MemberPatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen19386 (declare (salience 5))
	(Member
...
(defrule rule-gen19400 (declare (salience 5))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen19417 (declare (salience 5))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-variable-binding%3E)
		(object ?formulacontainer))
...
(defrule rule-gen19424 (declare (salience 5))
(or 	(Member
		(instance ?formulacontainer)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen19437 (declare (salience 5))
(or 	(Member
		(instance ?rifnot)
		(class <http://www.w3.org/2007/rif#INeg>))
		(Member
...
(defrule rule-gen19451 (declare (salience 5))
	(Member
		(instance ?riflist)
...
(defrule rule-gen19457 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen19470 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen19480 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen19505 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen19517 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen19541 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen19555 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19578 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19604 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen19630 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen19662 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen19679 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen19698 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifaction))
...
(defrule rule-gen19707 (declare (salience 5))
	(TripleTemplate
		(subject ?super)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?sub))
...
(defrule rule-gen19714 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?rifaction))
...
(defrule rule-gen19722 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://white.gobo/modelA#as-defrule>)
		(object ?defrule))
...
(defrule rule-gen19735 (declare (salience 5))
	(TripleTemplate
		(subject ?rifvar)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23use-expression-from%3E)
...
(defrule rule-gen19777 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen19790 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen19797 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen19833 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen19840 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen19850 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
		(predicate <http://www.w3.org/2007/rif#constname>)
		(object ?name))
...
(defrule rule-gen19859 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen19868 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen19890 (declare (salience -1))
	(Atom
...
(defrule rule-gen19896 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://example.com/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen19910 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen19988 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen20016 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen20066 
	(Member
		...
		(object ?clipsterm))
		=>
(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?tripletemplate (<http://white.gobo/new-blanknode>))(bind ?clipsretract (<http://white.gobo/new-blanknode>))(bind ?tmpvar (<http://white.gobo/new-blanknode>))(bind ?expandtriples (<http://white.gobo/new-blanknode>))(bind ?triplequery (<http://white.gobo/new-blanknode>))(bind ?findtriples (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifretract)
		(predicate <http://example.com/as-action>)
...
(defrule rule-gen20143 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen20150 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen20154 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
...
(defrule rule-gen20182 
	(Member
		...
		=>
(bind ?slotinstance (<http://white.gobo/new-blanknode>))(bind ?slotcls (<http://white.gobo/new-blanknode>))(bind ?rhspattern (<http://white.gobo/new-blanknode>))	(assert 	(TripleTemplate
		(subject ?rifmember)
		(predicate <http://example.com/as-rhspattern>)
		(object ?rhspattern)))
	(assert 	(TripleTemplate
...
(defrule rule-gen20212 (declare (salience -100))
	(Member
		(instance ?rifnode)
		(class <http://www.w3.org/2007/rif#Do>))
	(exists (and 	(TripleTemplate
...
(defrule rule-gen20221 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen20242 
	...
	(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist ?slot ))
		=>
(bind ?template (<http://white.gobo/new-blanknode>))(bind ?slotpred (<http://white.gobo/new-blanknode>))(bind ?function (<http://white.gobo/new-blanknode>))(bind ?factvar (<http://white.gobo/new-blanknode>))(bind ?funcchecksubj (<http://white.gobo/new-blanknode>))(bind ?binding (<http://white.gobo/new-blanknode>))(bind ?symbolsubject (<http://white.gobo/new-blanknode>))(bind ?extractval (<http://white.gobo/new-blanknode>))(bind ?slotsubj (<http://white.gobo/new-blanknode>))(bind ?query (<http://white.gobo/new-blanknode>))(bind ?funccheckpred (<http://white.gobo/new-blanknode>))	(assert 	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23processed-actionvar%3E)
		(args ?rifdo ?actionvar )))
	(do-for-all-facts ((?fct TripleTemplate)) 
		(and 
...
(defrule rule-gen20306 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen20310 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen20316 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen20325 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen20335 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen20339 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen20344 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(Member
...
(defrule rule-gen20367 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
		...
		(object ?assign))
		=>
(bind ?eq (<http://white.gobo/new-blanknode>))(bind ?position (<http://white.gobo/new-blanknode>))(bind ?function (<http://white.gobo/new-blanknode>))(bind ?testpattern (<http://white.gobo/new-blanknode>))	(assert 	(Member
		(instance ?testpattern)
		(class <http://clips.script/TestCE>)))
	(assert 	(TripleTemplate
		(subject ?testpattern)
...
(defrule rule-gen20390 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen20408 (declare (salience 10))
	(Atom
		(op %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23always-wrong%3E)
		(args ))
		(TripleTemplate
...
(defrule rule-gen20429 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen20439 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen20457 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen20472 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
	...
	(not 	(TripleTemplate
		...
		(object ?defrule)))
		=>
(bind ?tmplistasvar (<http://white.gobo/new-blanknode>))(bind ?testvarpattern (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
		(and (eq ?trpl:subject ?defrule) (eq ?trpl:predicate <http://clips.script/conditional-element>))
		(bind ?oldpatternlist ?trpl:object))(bind ?testvaraction (<http://white.gobo/new-blanknode>))(bind ?assignpattern (<http://white.gobo/new-blanknode>))	(assert 	(Member
