...
(defrule rule-gen16113 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16126 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16137 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16144 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16173 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16182 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(defrule rule-gen16190 (declare (salience 10))
	(Member
		(instance ?defrule)
		(class <http://clips.script/Defrule>))
		(Atom
...
(deffacts rule-gen16201
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen16202 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen16213 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
...
(defrule rule-gen16221 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16236 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16246 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16256 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16272 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
...
(defrule rule-gen16289 (declare (salience 10))
	(TripleTemplate
		(subject ?supergroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16304 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16336 (declare (salience -100))
	(Member
		(instance ?rifnode)
...
(defrule rule-gen16345 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen16430 (declare (salience -50))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen16443 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate <http://example.com/add-args-from>)
		(object ?rifarglist))
...
(defrule rule-gen16450 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen16468 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16476 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16482 (declare (salience 100))
	(TripleTemplate
		(subject ?clause)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?assert))
...
(defrule rule-gen16492 (declare (salience 100))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen16504 (declare (salience 100))
	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16512 (declare (salience 100))
	(Member
		(instance ?patterngen)
		(class <http://white.gobo/modelA#RHSPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16522 (declare (salience 100))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16598 (declare (salience 100))
	(Member
		(instance ?formula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16604 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16612 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16645 (declare (salience 100))
(or 	(Member
		(instance ?rifformula)
		(class <http://www.w3.org/2007/rif#Atom>))
		(Member
...
(defrule rule-gen16652 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16679 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16692 (declare (salience 100))
	(Member
		(instance ?rifformula)
...
(defrule rule-gen16700 (declare (salience 100))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen16708 (declare (salience 100))
	(TripleTemplate
		(subject ?rifimply)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?action))	=>
...
(defrule rule-gen16712 (declare (salience 100))
(or 	(Member
		(instance ?action)
...
(defrule rule-gen16722 (declare (salience 100))
(or 	(Member
		(instance ?action)
		(class <http://www.w3.org/2007/rif#Do>))
		(Member
...
(defrule rule-gen16776 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen16783 (declare (salience 80))
	(TripleTemplate
		(subject ?child)
...
(defrule rule-gen16787 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actions>)
		(object ?childlist))
...
(defrule rule-gen16802 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen16824 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#items>)
		(object ?arglist))
...
(defrule rule-gen16910 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen16926 (declare (salience 100))
	(Member
		(instance ?document)
...
(defrule rule-gen16932 (declare (salience 100))
	(TripleTemplate
		(subject ?document)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?group))
...
(defrule rule-gen16939 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
		(predicate <http://www.w3.org/2007/rif#actionVar>)
		(object ?actionvar))
...
(defrule rule-gen16947 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen16973 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?childlist))
...
(defrule rule-gen16986 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?child))
...
(defrule rule-gen17035 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen17051 (declare (salience 100))
	(TripleTemplate
		(subject ?target)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifdoinheritance%3E)
		(object ?parent))
...
(defrule rule-gen17157 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen17188 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen17293 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17321 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen17468 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen17487 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen17496 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen17518 (declare (salience -1))
	(Atom
...
(defrule rule-gen17538 (declare (salience -1))
	(Member
		(instance ?factvar)
		(class <http://clips.script/Variable>))
		(Atom
...
(defrule rule-gen17599 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen17603 (declare (salience 60))
	(TripleTemplate
		(subject ?rifnode)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object ?iristring))
...
(defrule rule-gen17607 (declare (salience 60))
	(Member
		(instance ?rifdocument)
		(class <http://www.w3.org/2007/rif#Document>))
		(TripleTemplate
...
(defrule rule-gen17616 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17620 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen17626 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen17635 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen17645 (declare (salience 10))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-as-expression-from%3E)
		(object ?itemlist))
...
(defrule rule-gen17649 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen17654 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen17677 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen17687 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen17705 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen17720 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen17738 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen17745 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen17752 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen17760 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen17781 (declare (salience 5))
	(Member
		(instance ?rifvar)
		(class <http://www.w3.org/2007/rif#Var>))
		(TripleTemplate
...
(defrule rule-gen17787 (declare (salience 5))
	(Member
		(instance ?riflist)
		(class <http://example.com/ConstraintGenerator>))
		(TripleTemplate
...
(defrule rule-gen17796 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen17813 (declare (salience 5))
	(Member
		(instance ?rifrule)
		(class <http://www.w3.org/2007/rif#And>))
		(TripleTemplate
...
(defrule rule-gen17832 (declare (salience 5))
(or 	(Member
		(instance ?rifobj)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
		(Member
...
(defrule rule-gen17872 (declare (salience 5))
	(Member
		(instance ?rifformula)
		(class <http://white.gobo/modelA#PatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen17899 (declare (salience 5))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rifvar))
...
(defrule rule-gen17917 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://www.w3.org/2007/rif#object>)
		(object ?rifvar))
...
(defrule rule-gen17954 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17970 (declare (salience 5))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen17988 (declare (salience 5))
	(TripleTemplate
		(subject ?rifatom)
		(predicate <http://www.w3.org/2007/rif#args>)
		(object ?arglist))
...
(defrule rule-gen17995 (declare (salience 5))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen18021 (declare (salience 5))
	(Member
		(instance ?rifor)
		(class <http://www.w3.org/2007/rif#Or>))
		(TripleTemplate
...
(defrule rule-gen18044 (declare (salience 5))
	(Member
		(instance ?rifequal)
		(class <http://white.gobo/modelA#ConditionGenerator>))
		(TripleTemplate
...
(defrule rule-gen18053 (declare (salience 5))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18089 (declare (salience 5))
	(TripleTemplate
		(subject ?rifexternal)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?rifatom))
...
(defrule rule-gen18121 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-expression-needs-var%3E))
		(TripleTemplate
...
(defrule rule-gen18132 (declare (salience 5))
	(Member
		(instance ?rifterm)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23check-expression-needs-var%3E))
		(Member
...
(defrule rule-gen18140 (declare (salience 5))
	(TripleTemplate
		(subject ?group)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentences))
...
(defrule rule-gen18148 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Or>))
		=>
...
(defrule rule-gen18151 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#INeg>))
		=>
...
(defrule rule-gen18154 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen18163 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen18177 (declare (salience 11))
	(Atom
...
(defrule rule-gen18191 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen18204 (declare (salience 5))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		=>
...
(defrule rule-gen18207 (declare (salience 5))
	(Member
		(instance ?rifand)
		(class <http://www.w3.org/2007/rif#And>))
	(not(exists (and 	(TripleTemplate
...
(defrule rule-gen18221 (declare (salience 5))
(or 	(Member
		(instance ?formula)
		(class %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23rifformula%3E))
		(Member
...
(defrule rule-gen18243 (declare (salience 20))
	(TripleTemplate
		(subject ?rifand)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?otherrifand))
...
(defrule rule-gen18256 (declare (salience 20))
	(TripleTemplate
		(subject ?rifforall)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifrule))
...
(defrule rule-gen18273 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen18301 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen18332 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen18361 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-after-conditions%3E)
		(object ?andpattern))
...
(defrule rule-gen18371 (declare (salience 5))
	(Member
...
(defrule rule-gen18387 (declare (salience 5))
(or 	(Member
		(instance ?formulacontainer)
		(class <http://www.w3.org/2007/rif#And>))
		(Member
...
(defrule rule-gen18420 (declare (salience 5))
	(Member
		(instance ?rifatom)
		(class <http://white.gobo/modelA#AtomPatternGenerator>))
		(TripleTemplate
...
(defrule rule-gen18431 (declare (salience 5))
	(Member
		(instance ?rifmember)
		(class <http://white.gobo/modelA#MemberPatternGenerator>))
	(or 	(TripleTemplate
...
(defrule rule-gen18445 (declare (salience 5))
	(Member
...
(defrule rule-gen18476 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18489 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen18499 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen18524 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18536 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen18548 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen18560 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18574 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18597 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18620 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen18643 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen18689 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen18708 (declare (salience 5))
(or 	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifaction))
...
(defrule rule-gen18717 (declare (salience 5))
	(TripleTemplate
		(subject ?super)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?sub))
...
(defrule rule-gen18724 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-as-action%3E)
		(object ?rifaction))
...
(defrule rule-gen18732 (declare (salience 5))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://white.gobo/modelA#as-defrule>)
		(object ?defrule))
...
(defrule rule-gen18745 (declare (salience 5))
	(TripleTemplate
		(subject ?rifvar)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23use-expression-from%3E)
...
(defrule rule-gen18877 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen18884 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen18888 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
