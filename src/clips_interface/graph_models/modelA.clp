...
(defrule rule-gen7786 (declare (salience 10))
	(TripleTemplate
		(subject ?group)
...
(defrule rule-gen7805 (declare (salience 10))
	(TripleTemplate
		(subject ?rule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
...
(defrule rule-gen8163 
	...
	(not 	(TripleTemplate
		...
		(object ?slot)))
		=>
(bind ?slotsubject (<http://white.gobo/new-blanknode>))(bind ?clipsconditionalelement (<http://white.gobo/new-blanknode>))(bind ?slotpredicate (<http://white.gobo/new-blanknode>))(do-for-fact ((?trpl TripleTemplate))
...
(defrule rule-gen8252 (declare (salience 20))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen8271 (declare (salience 3))
	(TripleTemplate
		(subject ?defrule)
		(predicate <http://example.com/uses-patterns-as-conditional>)
		(object ?rifrule))
...
(defrule rule-gen8281 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
		(predicate ?prop)
...
(defrule rule-gen8285 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen8292 (declare (salience 100))
	(TripleTemplate
		(subject ?base)
...
(defrule rule-gen8299 (declare (salience 100))
	(TripleTemplate
		(subject ?subject)
		(predicate ?prop)
		(object ?listbase))
...
(defrule rule-gen8306 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen8319 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
...
(defrule rule-gen8335 (declare (salience 90))
	(TripleTemplate
		(subject ?outerrule)
		(predicate <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>)
		(object <http://www.w3.org/2007/rif#Forall>))
