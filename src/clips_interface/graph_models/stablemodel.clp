...
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?subformula ))
...
(not
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subformula ))
)
	=>
(assert(TripleTemplate (subject  ?subformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))))

(defrule rule2 (declare (salience -12))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifequal ))
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifequal ))
)
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsassign ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifright ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsassign )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifequal )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#TestPatternLeftAssignGenerator> )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#PatternGenerator> )))(assert(Member (instance  ?rifright ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsassign ))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-binds-var> ) (object  ?clipsconstraint ))
	=>
(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-binds-var> ) (object  ?clipsconstraint ))))

(defrule rule4 (declare (salience 11))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expressions-needs-var> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsconstraint ))
...
(defrule rule6 (declare (salience -12))
(TripleTemplate (subject  ?rifequal ) (predicate  <http://www.w3.org/2007/rif#right> ) (object  ?rifright ))
(Member (class  <http://www.w3.org/2007/rif#Equal> ) (instance  ?rifequal ))
...
(exists
(and
(TripleTemplate (subject  ?rifleft ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?formula ))
	...
	=>
(assert(Member (instance  ?formula ) (class  <http://white.gobo/local/b/n530de320_n10588#rifformula> ))))
...
(Atom (op  <http://white.gobo/local/b/n530de320_n10588#always-false> ) (args ))
	=>
(assert(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?clipsvar ))))
...
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(exists
(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?x ))
)
	=>
(assert(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?formula ))))

(defrule rule11 (declare (salience 5))
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?unboundvar ))
(Member (class  <http://white.gobo/modelA#ListAsConstraint> ) (instance  ?riflist ))
(not
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?unboundvar ))
)
	=>
(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?unboundvar ))))

(defrule rule12 (declare (salience 11))
...
(TripleTemplate (subject  ?formula ) (predicate  <http://www.w3.org/2007/rif#vars> ) (object  ?varlist ))
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#subpattern-needs-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifframe ))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist   ?slot  ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?slot ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?itemlist   ?rifvar  ))
	...
	=>
(assert(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-binds-var> ) (object  ?clipsconstraint ))))

(defrule rule15 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?formula ))
	=>
 (bind ?clipsexists   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsexists )))(assert(Member (instance  ?clipsexists ) (class  <http://clips.script/ExistsCE> )))(assert(TripleTemplate (subject  ?clipsexists ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(TripleTemplate (subject  ?arg ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule17 (declare (salience -7))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifexternal ))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifexternal ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifexternal ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expressions-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifexternal ))) (do-for-all-facts (( ?fct17 TripleTemplate)) (and (eq ?fct17:subject   ?formulacontainer  )  (eq ?fct17:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct17  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifexternal  ))))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#TestPatternExternalGenerator> )))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule18 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifterm ) (predicate  <http://example.com/inherits-data> ) (object  ?rifvar ))
(Member (class  <http://white.gobo/local/b/n530de320_n10588#check-expression-needs-var> ) (instance  ?rifterm ))
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?clipsvar ))))

(defrule rule19 (declare (salience -100))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
...
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?subpattern ))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subpattern ))
)
(not
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#subpattern-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
...
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?subsub ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subsub ))
)
)
)
)
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?subpattern ))
	...
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct23 TripleTemplate)) (and (eq ?fct23:subject   ?superpattern  )  (eq ?fct23:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct23  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))

(defrule rule21 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifterm ) (predicate  <http://example.com/inherits-data> ) (object  ?rifvar ))
(Member (class  <http://white.gobo/local/b/n530de320_n10588#check-constraint-needs-var> ) (instance  ?rifterm ))
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-needs-var> ) (object  ?clipsvar ))))
...
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
(exists
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?x ))
)
(not
(exists
(and
...
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subsub ))
	...
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct12 TripleTemplate)) (and (eq ?fct12:subject   ?superpattern  )  (eq ?fct12:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct12  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-constraint> ) (object  ?clipsvar ))
	=>
(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n530de320_n10588#triple-connected-to> ) (object  ?clipsvar ))))

(defrule rule27 (declare (salience -1))
(or
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
	...
	=>
 (do-for-all-facts (( ?fct19 TripleTemplate)) (and (eq ?fct19:subject   ?formulacontainer  )  (eq ?fct19:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct19  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct20 TripleTemplate)) (and (eq ?fct20:subject   ?superpattern  )  (eq ?fct20:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct20  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer ))))

(defrule rule28 (declare (salience -8))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?slot ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist   ?slot  ))
...
(exists
(and
(TripleTemplate (subject  ?frameobject ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
...
(and
(or
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#triple-connected-to> ) (object  ?x ))
(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n530de320_n10588#triple-connected-to> ) (object  ?x ))
)
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
...
(exists
(and
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?slot ))
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?slot )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifframe ))) (do-for-all-facts (( ?fct18 TripleTemplate)) (and (eq ?fct18:subject   ?formulacontainer  )  (eq ?fct18:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct18  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?slot  ))))(assert(Member (instance  ?slot ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer )))(assert(Member (instance  ?rifframe ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer ))))

(defrule rule29 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n530de320_n10588#use-expression-from> ) (object  ?rifexpression ))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifpattern ))
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/local/b/n530de320_n10588#check-constraint-needs-var> ))))
...
(exists
(and
(Member (class  <http://white.gobo/local/b/n530de320_n10588#rifformula> ) (instance  ?otherformula ))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifatom ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
...
(TripleTemplate (subject  ?rifequal ) (predicate  <http://www.w3.org/2007/rif#right> ) (object  ?right ))
	=>
(assert(Member (instance  ?left ) (class  <http://white.gobo/local/b/n530de320_n10588#check-expression-needs-var> )))(assert(Member (instance  ?right ) (class  <http://white.gobo/local/b/n530de320_n10588#check-expression-needs-var> ))))
...
(TripleTemplate (subject  ?arg ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?clipsvar ))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
(Member (class  <http://white.gobo/modelA#PatternGenerator> ) (instance  ?rifexternal ))
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://www.w3.org/2007/rif#content> ) (object  ?rifatom ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
...
(defrule rule35 (declare (salience 11))
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?rifineg ))
	=>
(assert(TripleTemplate (subject  ?rifineg ) (predicate  <http://white.gobo/local/b/n530de320_n10588#subpattern-needs-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?slot )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifframe ))) (do-for-all-facts (( ?fct14 TripleTemplate)) (and (eq ?fct14:subject   ?formulacontainer  )  (eq ?fct14:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct14  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?slot  ))))(assert(Member (instance  ?slot ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer )))(assert(Member (instance  ?rifframe ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(exists
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?x ))
)
(or
...
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifand ))
	...
	=>
(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?formula ))))
...
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?otherrifand ))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?formulalist   ?rifformula  ))
	...
	=>
(assert(TripleTemplate (subject  ?otherrifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?otherrifand )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifformula ))))
...
(not
(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
...
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-needs-var> ) (object  ?clipsvar ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?rifvar  ))

	=>
(assert(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?clipsvar ))))
...
(exists
(and
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifatom ))
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifatom ))) (do-for-all-facts (( ?fct26 TripleTemplate)) (and (eq ?fct26:subject   ?formulacontainer  )  (eq ?fct26:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct26  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifatom  ))))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#AtomPatternGenerator> )))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraint-binds-var> ) (object  ?clipsconstraint ))
(not
(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsconstraint ))
)
(or
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?formula ))
	=>
 (bind ?clipsnot   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsnot )))(assert(Member (instance  ?clipsnot ) (class  <http://clips.script/NotCE> )))(assert(TripleTemplate (subject  ?clipsnot ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule44 (declare (salience 20))
(or
(TripleTemplate (subject  ?rifrule ) (predicate  <http://www.w3.org/2007/rif#if> ) (object  ?rifformula ))
(TripleTemplate (subject  ?rifrule ) (predicate  <http://www.w3.org/2007/rif#formula> ) (object  ?rifformula ))
)
(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifrule ))
(or
...
(Member (class  <http://www.w3.org/2007/rif#Forall> ) (instance  ?rifrule ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifrule )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifformula ))))
...
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subformula ))
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifand ))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifmember ))
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?rifmember ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifmember ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct15 TripleTemplate)) (and (eq ?fct15:subject   ?formulacontainer  )  (eq ?fct15:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct15  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#MemberPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule48 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifand ))
(not
(exists
...
(TripleTemplate (subject  ?superimply ) (predicate  <http://www.w3.org/2007/rif#if> ) (object  ?rifand ))
	...
	=>
 (bind ?clipsand   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsand )))(assert(Member (instance  ?clipsand ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?clipsand ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(TripleTemplate (subject  ?rifformula ) (predicate  <http://www.w3.org/2007/rif#super> ) (object  ?rifvar ))
	...
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#constraints-needs-variable> ) (object  ?clipsvar ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?sentences   ?rifrule  ))
	...
	=>
 (bind ?defrule   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?defrule )))(assert(Member (instance  ?defrule ) (class  <http://clips.script/Defrule> )))(assert(TripleTemplate (subject  ?defrule ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule51 (declare (salience -7))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifequal ))
(Member (class  <http://www.w3.org/2007/rif#Equal> ) (instance  ?rifequal ))
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifequal ))
...
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifequal ))) (do-for-all-facts (( ?fct13 TripleTemplate)) (and (eq ?fct13:subject   ?formulacontainer  )  (eq ?fct13:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct13  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifequal  ))))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#TestPatternEqualGenerator> )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#PatternGenerator> )))(assert(Member (instance  ?rifleft ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(Member (instance  ?rifright ) (class  <http://white.gobo/modelA#ExpressionGenerator> ))))
...
(test (eq ?targetstring   (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist   "1^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
(assert(Member (instance  ?targetiri ) (class  <http://white.gobo/local/b/n530de320_n10588#check-expression-needs-var> )))(assert(Member (instance  ?targetstring ) (class  <http://white.gobo/local/b/n530de320_n10588#check-expression-needs-var> ))))
...
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer ))
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))))

(defrule rule55 (declare (salience -1))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  ?patternlist ))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?subpattern ))
(test (eq ?formula   (<http://www.w3.org/2007/rif-builtin-function#get> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
...
(Member (class  <http://clips.script/NotCE> ) (instance  ?superpattern ))
	...
	=>
 (bind ?andpattern   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?andpattern ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-after-conditions> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct16 TripleTemplate)) (and (eq ?fct16:subject   ?formulacontainer  )  (eq ?fct16:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct16  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct22 TripleTemplate)) (and (eq ?fct22:subject   ?superpattern  )  (eq ?fct22:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct22  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?andpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?pattern ))
(not
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?pattern ))
)
	=>
...
(defrule rule60 (declare (salience -1))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transfer-after-conditions> ) (object  ?andpattern ))
(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  ?conditions ))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?aftercondition ))
(not
(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transferred-after-condition> ) (object  ?andpattern ))
)
	=>
(assert(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n530de320_n10588#transferred-after-condition> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct24 TripleTemplate)) (and (eq ?fct24:subject   ?andpattern  )  (eq ?fct24:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct24  ) ) (assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?conditions   ?aftercondition  )))))

(defrule rule61 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Or> ) (instance  ?formula ))
	=>
 (bind ?clipsor   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsor )))(assert(Member (instance  ?clipsor ) (class  <http://clips.script/OrCE> )))(assert(TripleTemplate (subject  ?clipsor ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(defrule rule63 (declare (salience -1))
(or
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?superpattern ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
)
...
(exists
(and
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
)
)
...
(TripleTemplate (subject  ?rifslot ) (predicate  <http://www.w3.org/2007/rif#slotkey> ) (object  ?rifvar ))
	...
	=>
(assert(TripleTemplate (subject  ?rifslot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#triple-connected-to> ) (object  ?clipsvar ))))
...
(exists
(and
(TripleTemplate (subject  ?targetstring ) (predicate  <http://white.gobo/local/b/n530de320_n10588#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
)
)
...
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsassign ))
)
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifexternal ))
)
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#AssignGenerator> )))(assert(TripleTemplate (subject  ?targetiri ) (predicate  <http://white.gobo/local/b/n530de320_n10588#use-expression-from> ) (object  ?targetstring )))(assert(Member (instance  ?targetstring ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifexternal )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?targetstring ))))

(defrule rule67 (declare (salience -7))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?rifmember ))
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?rifmember ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  ?formulalist ))
(not
...
(exists
(and
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))
...
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct11 TripleTemplate)) (and (eq ?fct11:subject   ?formulacontainer  )  (eq ?fct11:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct11  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#MemberPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#add-pattern-from> ) (object  ?formula ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?formula ))
)
(or
...
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?formulacontainer ))
	...
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://example.com/brubru5> ) (object  ?clipsvar )))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))
(or
...
(not
(exists
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?subpattern ))
)
)
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n530de320_n10588#bound-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifmember ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct21 TripleTemplate)) (and (eq ?fct21:subject   ?formulacontainer  )  (eq ?fct21:predicate   <http://white.gobo/local/b/n530de320_n10588#formulalist>  ) ) (retract ?fct21  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n530de320_n10588#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#SubclassPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(defrule rule104
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-additional-patterns-to> ) (object  ?multipattern ))
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-item-from> ) (object  ?rifitems ))
...
(TripleTemplate (subject  ?item ) (predicate  <http://example.com/as-constraint> ) (object  ?term ))
	=>
 (do-for-all-facts (( ?fct37 TripleTemplate)) (and (eq ?fct37:subject   ?items  )  (eq ?fct37:predicate   <http://white.gobo/local/b/n530de320_n5722#add-item-from>  ) ) (retract ?fct37  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-item-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifitems   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct36 TripleTemplate)) (and (eq ?fct36:subject   ?items  )  (eq ?fct36:predicate   <http://clips.script/constraints>  ) ) (retract ?fct36  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?term  ))))(assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-list> ) (object  ?item ))))
...
(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  ?oldlist ))
	=>
 (do-for-all-facts (( ?fct33 TripleTemplate)) (and (eq ?fct33:subject   ?items  )  (eq ?fct33:predicate   <http://white.gobo/local/b/n530de320_n5722#add-item-from>  ) ) (retract ?fct33  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-item-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifitems   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct34 TripleTemplate)) (and (eq ?fct34:subject   ?items  )  (eq ?fct34:predicate   <http://clips.script/constraints>  ) ) (retract ?fct34  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?term  )))))

(defrule rule106
(TripleTemplate (subject  ?list ) (predicate  <http://www.w3.org/2007/rif#rest> ) (object  ?rest ))
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#use-items-from> ) (object  ?list ))
(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-item-from> ) (object  ?rifitems ))
...
(not
(Member (class  <http://white.gobo/local/b/n530de320_n5722#OpenList> ) (instance  ?items ))
)
	=>
 (bind ?anyslots   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#added-rest> ) (object  ?rest )))(assert(Member (instance  ?anyslots ) (class  <http://clips.script/MultifieldVariable> )))(assert(TripleTemplate (subject  ?anyslots ) (predicate  <http://clips.script/variable-name> ) (object  "" ))) (do-for-all-facts (( ?fct35 TripleTemplate)) (and (eq ?fct35:subject   ?items  )  (eq ?fct35:predicate   <http://clips.script/constraints>  ) ) (retract ?fct35  ) ) (assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?anyslots  ))))(assert(Member (instance  ?items ) (class  <http://white.gobo/local/b/n530de320_n5722#OpenList> ))))
...
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-list> ) (object  ?riflist ))
...
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-list> ) (object  ?list ))
(TripleTemplate (subject  ?list ) (predicate  <http://example.com/as-constraint> ) (object  ?listvar ))
(not
(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#added-list> ) (object  ?list ))
)
	=>
 (bind ?checkvar   (<http://white.gobo/new-blanknode>) ) (bind ?pattern   (<http://white.gobo/new-blanknode>) ) (bind ?oldlist   (do-for-fact (( ?fct4 TripleTemplate)) (and (eq ?fct4:subject   ?multipattern  )  (eq ?fct4:predicate   <http://clips.script/conditional-element>  ) ) (fact-slot-value ?fct4   object  ) )  ) (bind ?check   (<http://white.gobo/new-blanknode>) ) (bind ?items   (<http://white.gobo/new-blanknode>) ) (bind ?assign   (<http://white.gobo/new-blanknode>) ) (bind ?checkfunction   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?checkvar ) (class  <http://example.com/Variable> )))(assert(Member (instance  ?checkvar ) (class  <http://clips.script/Variable> )))(assert(Member (instance  ?assign ) (class  <http://clips.script/AssignedPatternCE> )))(assert(TripleTemplate (subject  ?assign ) (predicate  <http://clips.script/fact-var-symbol> ) (object  ?checkvar )))(assert(TripleTemplate (subject  ?assign ) (predicate  <http://clips.script/pattern-ce> ) (object  ?pattern )))(assert(Member (instance  ?pattern ) (class  <http://clips.script/TemplatePatternCE> )))(assert(TripleTemplate (subject  ?pattern ) (predicate  <http://clips.script/deftemplate-name> ) (object  "AtomList" )))(assert(TripleTemplate (subject  ?pattern ) (predicate  <http://clips.script/slot> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?items  ))))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-additional-patterns-to> ) (object  ?multipattern )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/slot-name> ) (object  "items" )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-item-from> ) (object  ?rifitems )))(assert(TripleTemplate (subject  ?items ) (predicate  <http://white.gobo/local/b/n530de320_n5722#use-items-from> ) (object  ?list )))(assert(Member (instance  ?check ) (class  <http://clips.script/TestCE> )))(assert(TripleTemplate (subject  ?check ) (predicate  <http://clips.script/function-call> ) (object  ?checkfunction )))(assert(TripleTemplate (subject  ?checkfunction ) (predicate  <http://clips.script/function-name> ) (object  "eq" )))(assert(TripleTemplate (subject  ?checkfunction ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?checkvar   ?listvar  )))) (do-for-all-facts (( ?fct38 TripleTemplate)) (and (eq ?fct38:subject   ?multipattern  )  (eq ?fct38:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct38  ) ) (assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldlist   ?assign   ?check  ))))(assert(TripleTemplate (subject  ?multipattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#added-list> ) (object  ?list ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?list  ))
	...
	=>
(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-list> ) (object  ?list ))))
...
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?list ))
	=>
 (bind ?andpattern   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-multi-lhs-pattern> ) (object  ?andpattern )))(assert(Member (instance  ?andpattern ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?formulapattern  ))))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://white.gobo/local/b/n530de320_n5722#add-list> ) (object  ?list ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?rifarglist  ))
	...
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifexecute ) (predicate  <http://example.com/as-action> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?function  ))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  ?functionname )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n530de320_n5034#add-args-from> ) (object  ?rifarglist ))))
...
(TripleTemplate (subject  ?slotitems ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-constraints-from> ) (object  ?itemlist ))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#rest> ) (object  ?rest ))
	...
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/as-expression> ) (object  ?function )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  "%3Chttp%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-function%23make-list%3E" )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from> ) (object  ?itemlist ))))

(defrule rule122 (declare (salience 10))
(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from> ) (object  ?itemlist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?itemlist  ))

(test (eq "0^^http://www.w3.org/2001/XMLSchema#integer"   (<http://www.w3.org/2007/rif-builtin-function#count> ?itemlist  ) ))

	=>
 (retract(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from> ) (object  ?itemlist ))) ))

(defrule rule123 (declare (salience -101))
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from> ) (object  ?arglist ))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#rest> ) (object  ?rest ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/add-as-pattern> ) (object  ?defrule ))
(Atom (op  <http://white.gobo/local/b/n530de320_n4339#combine-multifield-as-list> ) (args  ?rest  ?multifieldvar ))
(not
...
(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  ?currentexprlist ))
	=>
 (do-for-all-facts (( ?fct41 TripleTemplate)) (and (eq ?fct41:subject   ?function  )  (eq ?fct41:predicate   <http://clips.script/function-args>  ) ) (retract ?fct41  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?currentexprlist   ?firstasexpression  )))) (do-for-all-facts (( ?fct42 TripleTemplate)) (and (eq ?fct42:subject   ?function  )  (eq ?fct42:predicate   <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from>  ) ) (retract ?fct42  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n530de320_n4339#add-args-as-expression-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n530de320_n4073#add-atom-args-as-constraint> ) (object  ?arglist ))
(TripleTemplate (subject  ?firstarg ) (predicate  <http://example.com/as-constraint> ) (object  ?clipsexpr ))
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))

	=>
 (bind ?oldconstraints   (do-for-fact (( ?fct8 TripleTemplate)) (and (eq ?fct8:subject   ?slotargs  )  (eq ?fct8:predicate   <http://clips.script/constraints>  ) ) (fact-slot-value ?fct8   object  ) )  ) (do-for-all-facts (( ?fct48 TripleTemplate)) (and (eq ?fct48:subject   ?slotargs  )  (eq ?fct48:predicate   <http://white.gobo/local/b/n530de320_n4073#add-atom-args-as-constraint>  ) ) (retract ?fct48  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n530de320_n4073#add-atom-args-as-constraint> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct47 TripleTemplate)) (and (eq ?fct47:subject   ?slotargs  )  (eq ?fct47:predicate   <http://clips.script/constraints>  ) ) (retract ?fct47  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldconstraints   ?clipsexpr  )))))
...
(not
(Atom (op  <http://white.gobo/local/b/n530de320_n3091#processed-actionvar> ) (args  ?rifnode  ?actionvar ))
)
)
)
	=>
...
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))
...
(TripleTemplate (subject  ?group ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?localconst ))
	=>
...
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?slotlist  ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?child ))))
...
(TripleTemplate (subject  ?document ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?localconst ))
...
;problem rule
;http://example.com/inheritance#rule23
(or
...
(TripleTemplate (subject  ?rifconstraint ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))
	=>
...
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))
	=>
 (retract(assert(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))) ))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?childlist   ?child  ))
	...
	=>
(assert(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n530de320_n1769#rifdoinheritance> ) (object  ?rifdo ))))
...
(TripleTemplate (subject  ?var ) (predicate  <http://www.w3.org/2007/rif#varname> ) (object  ?name ))
(TripleTemplate (subject  ?target ) (predicate  <http://www.w3.org/2007/rif#varname> ) (object  ?name ))
(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n530de320_n1769#rifdoinheritance> ) (object  ?parent ))
...
(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n530de320_n1769#give-inheritance> ) (object  ?target ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?target ))
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifformula ))
(or
...
;problem rule
;<http://example.com/apply-generator#rule15>
(or
...
;problem rule
;<http://example.com/apply-generator#rule21>
(or
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?child ))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?child ))
)
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n530de320_n683#priority> ) (object  "0^^http://www.w3.org/2001/XMLSchema#integer" ))))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://www.w3.org/2007/rif#formula> ) (object  ?rifaction ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n530de320_n683#add-as-action> ) (object  ?rifaction ))))
...
(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n530de320_n683#priority> ) (object  ?priority ))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n530de320_n683#add-as-action> ) (object  ?rifaction ))
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?priority ))
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n530de320_n683#priority> ) (object  ?priority ))))
...
(TripleTemplate (subject  ?supergroup ) (predicate  <http://white.gobo/local/b/n530de320_n683#priority> ) (object  ?priority ))
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?subgroup ) (predicate  <http://white.gobo/local/b/n530de320_n683#priority> ) (object  ?priority ))))

(defrule rule218 (declare (salience 10))
(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n530de320_n683#add-as-action> ) (object  ?sub ))
(TripleTemplate (subject  ?sub ) (predicate  <http://white.gobo/local/b/n530de320_n683#add-as-action> ) (object  ?rifaction ))
	=>
(assert(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n530de320_n683#add-as-action> ) (object  ?rifaction ))))

(deffacts facts90c6b680
(Atom (op  <http://example.com/currentfactindex> ) (args  "1^^http://www.w3.org/2001/XMLSchema#integer" ))
)

(deffacts factsbac7dd50
