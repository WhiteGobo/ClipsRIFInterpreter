...
(TripleTemplate (subject  ?clipsretract ) (predicate  <http://example.com/retract-uses-pattern-from> ) (object  ?rifformula ))
	=>
 (bind ?retracttargets   (do-for-fact (( ?fct2 TripleTemplate)) (and (eq ?fct2:subject   ?clipsretract  )  (eq ?fct2:predicate   <http://clips.script/function-args>  ) ) (fact-slot-value ?fct2   object  ) )  ) (bind ?clipsassert   (<http://white.gobo/new-blanknode>) ) (do-for-all-facts (( ?fct14 TripleTemplate)) (and (eq ?fct14:subject   ?clipsretract  )  (eq ?fct14:predicate   <http://clips.script/function-args>  ) ) (retract ?fct14  ) ) (assert(TripleTemplate (subject  ?clipsretract ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?retracttargets   ?clipsassert  ))))(assert(TripleTemplate (subject  ?clipsassert ) (predicate  <http://clips.script/assert> ) (object  ?rhspattern ))))
...
(defrule rule11 (declare (salience -100))
...
(test (eq "1^^http://www.w3.org/2001/XMLSchema#integer"   (<http://www.w3.org/2007/rif-builtin-function#count> ?slotlist  ) ))
	...
	=>
 (bind ?slotpred   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?slotpred ) (predicate  <http://clips.script/member-variable> ) (object  ?tmpvar )))(assert(TripleTemplate (subject  ?slotpred ) (predicate  <http://clips.script/member-slot-name> ) (object  "predicate" ))) (do-for-all-facts (( ?fct12 TripleTemplate)) (and (eq ?fct12:subject   ?comparepredicate  )  (eq ?fct12:predicate   <http://clips.script/function-name>  ) ) (retract ?fct12  ) ) (assert(TripleTemplate (subject  ?comparepredicate ) (predicate  <http://clips.script/function-name> ) (object  "eq" ))) (do-for-all-facts (( ?fct13 TripleTemplate)) (and (eq ?fct13:subject   ?comparepredicate  )  (eq ?fct13:predicate   <http://clips.script/function-args>  ) ) (retract ?fct13  ) ) (assert(TripleTemplate (subject  ?comparepredicate ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?slotpred   ?slotkeyterm  )))))
...
(defrule rule15 (declare (salience 10))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (bind ?oldfield   (do-for-fact (( ?fct3 TripleTemplate)) (and (eq ?fct3:subject   ?slotargs  )  (eq ?fct3:predicate   <http://clips.script/field>  ) ) (fact-slot-value ?fct3   object  ) )  ) (do-for-all-facts (( ?fct10 TripleTemplate)) (and (eq ?fct10:subject   ?slotargs  )  (eq ?fct10:predicate   <http://example.com/add-atom-args-rhspattern>  ) ) (retract ?fct10  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://example.com/add-atom-args-rhspattern> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct11 TripleTemplate)) (and (eq ?fct11:subject   ?slotargs  )  (eq ?fct11:predicate   <http://clips.script/field>  ) ) (retract ?fct11  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://clips.script/field> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldfield   ?clipsexpr  )))))

(defrule rule16 (declare (salience -100))
...
(not
(Atom (op  <http://white.gobo/local/b/n6951d320_n9009#processed-actionvar> ) (args  ?rifnode  ?actionvar ))
)
)
)
	=>
...
(Atom (op  <http://white.gobo/local/b/n6951d320_n9009#processed-actionvar> ) (args  ?rifnode  ?actionvar ))
	...
	=>
 (do-for-all-facts (( ?fct16 TripleTemplate)) (and (eq ?fct16:subject   ?rifnode  )  (eq ?fct16:predicate   <http://example.com/in-transform-do>  ) ) (retract ?fct16  ) ) (assert(TripleTemplate (subject  ?rifnode ) (predicate  <http://example.com/in-transform-do> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?in   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct17 TripleTemplate)) (and (eq ?fct17:subject   ?rifnode  )  (eq ?fct17:predicate   <http://example.com/out-transform-do>  ) ) (retract ?fct17  ) ) (assert(TripleTemplate (subject  ?rifnode ) (predicate  <http://example.com/out-transform-do> ) (object  (<http://www.w3.org/2007/rif-builtin-function#concatenate> ?out   ?nextactions  )))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?rifarglist  ))
	...
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifexecute ) (predicate  <http://example.com/as-action> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?function  ))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  ?functionname )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n8455#add-args-from> ) (object  ?rifarglist ))))

(defrule rule25 (declare (salience 15))
(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n8455#add-args-from> ) (object  ?rifarglist ))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (bind ?functionargs   (do-for-fact (( ?fct4 TripleTemplate)) (and (eq ?fct4:subject   ?function  )  (eq ?fct4:predicate   <http://clips.script/function-args>  ) ) (fact-slot-value ?fct4   object  ) )  ) (do-for-all-facts (( ?fct20 TripleTemplate)) (and (eq ?fct20:subject   ?function  )  (eq ?fct20:predicate   <http://clips.script/function-args>  ) ) (retract ?fct20  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?functionargs   ?clipsexpression  )))) (do-for-all-facts (( ?fct19 TripleTemplate)) (and (eq ?fct19:subject   ?function  )  (eq ?fct19:predicate   <http://white.gobo/local/b/n6951d320_n8455#add-args-from>  ) ) (retract ?fct19  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n8455#add-args-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(TripleTemplate (subject  ?supergroup ) (predicate  <http://white.gobo/local/b/n6951d320_n8261#priority> ) (object  ?priority ))
...
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?subgroup ) (predicate  <http://white.gobo/local/b/n6951d320_n8261#priority> ) (object  ?priority ))))
...
(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n6951d320_n8261#priority> ) (object  ?priority ))
...
(defrule rule34 (declare (salience 10))
(TripleTemplate (subject  ?rifrule ) (predicate  <http://example.com/add-rule-info> ) (object  ?defrule ))
...
(defrule rule35 (declare (salience 10))
...
(defrule rule37 (declare (salience 10))
...
(TripleTemplate (subject  ?rifgroup ) (predicate  <http://www.w3.org/2007/rif#behavior> ) (object  ?behavior ))
	...
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n6951d320_n8261#priority> ) (object  "0^^http://www.w3.org/2001/XMLSchema#integer" ))))
...
(defrule rule39 (declare (salience 10))
(Member (class  <http://clips.script/Defrule> ) (instance  ?defrule ))
...
(defrule rule40 (declare (salience 10))
(or
...
(defrule rule41 (declare (salience 10))
(TripleTemplate (subject  ?behavior ) (predicate  <http://www.w3.org/2007/rif#Priority> ) (object  ?priority ))
(TripleTemplate (subject  ?rifgroup ) (predicate  <http://www.w3.org/2007/rif#behavior> ) (object  ?behavior ))
	=>
(assert(TripleTemplate (subject  ?rifgroup ) (predicate  <http://white.gobo/local/b/n6951d320_n8261#priority> ) (object  ?priority ))))
...
(defrule rule43 (declare (salience -1))
...
(defrule rule44 (declare (salience -102))
...
(defrule rule45 (declare (salience -1))
(Atom (op  <http://example.com/currentfactindex> ) (args  ?factindex ))
...
(defrule rule46 (declare (salience 60))
...
(defrule rule48 (declare (salience -100))
...
(defrule rule49 (declare (salience -100))
...
(defrule rule50 (declare (salience -102))
...
(defrule rule54 (declare (salience 60))
...
(defrule rule55 (declare (salience 60))
(TripleTemplate (subject  ?rifdocument ) (predicate  <http://example.com/inherits-data> ) (object  ?riflocal ))
(TripleTemplate (subject  ?riflocal ) (predicate  <http://www.w3.org/2007/rif#constname> ) (object  ?name ))
(Member (class  <http://www.w3.org/2007/rif#Document> ) (instance  ?rifdocument ))
	=>
...
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
	=>
(assert(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-binds-var> ) (object  ?clipsconstraint ))))

(defrule rule59 (declare (salience -10))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifequal ))
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifequal ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifleft ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
...
(exists
(and
(TripleTemplate (subject  ?rifright ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifequal ))) (do-for-all-facts (( ?fct28 TripleTemplate)) (and (eq ?fct28:subject   ?formulacontainer  )  (eq ?fct28:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct28  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifequal  ))))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#TestPatternEqualGenerator> )))(assert(Member (instance  ?rifequal ) (class  <http://white.gobo/modelA#PatternGenerator> )))(assert(Member (instance  ?rifleft ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(Member (instance  ?rifright ) (class  <http://white.gobo/modelA#ExpressionGenerator> ))))

(defrule rule60 (declare (salience 5))
(Member (class  <http://white.gobo/modelA#PatternGenerator> ) (instance  ?rifformula ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-binds-var> ) (object  ?clipsconstraint ))
(not
(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsconstraint ))
)
(or
...
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subformula ))
...
(exists
(and
(Member (class  <http://white.gobo/local/b/n6951d320_n6554#rifformula> ) (instance  ?otherformula ))
(not
...
(defrule rule63 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsexpression ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(Atom (op  <http://white.gobo/local/b/n6951d320_n6554#check-binding> ) (args  ?rifvar ))
	=>
(assert(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsexpression ))))

(defrule rule64 (declare (salience 5))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
(TripleTemplate (subject  ?arg ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsvar ))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?arg ))
	...
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule65 (declare (salience -10))
(TripleTemplate (subject  ?rifframe ) (predicate  <http://www.w3.org/2007/rif#slots> ) (object  ?slotlist ))
(TripleTemplate (subject  ?slot ) (predicate  <http://www.w3.org/2007/rif#slotvalue> ) (object  ?slotvalue ))
(TripleTemplate (subject  ?slot ) (predicate  <http://www.w3.org/2007/rif#slotkey> ) (object  ?slotkey ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifframe ))
...
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?slot ))
)
(not
(exists
(and
(TripleTemplate (subject  ?frameobject ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
...
(exists
(and
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?slot )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifframe ))) (do-for-all-facts (( ?fct29 TripleTemplate)) (and (eq ?fct29:subject   ?formulacontainer  )  (eq ?fct29:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct29  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?slot  ))))(assert(Member (instance  ?slot ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?slot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer )))(assert(Member (instance  ?rifframe ) (class  <http://white.gobo/modelA#TripleTemplateGenerator> )))(assert(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?unboundvar ))
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?riflist ))
(not
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?unboundvar ))
)
	=>
(assert(Member (instance  ?riflist ) (class  <http://white.gobo/modelA#ListAsConstraint> ))))

(defrule rule67 (declare (salience -10))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifexternal ))
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifexternal ))
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifexternal ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expressions-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifexternal ))) (do-for-all-facts (( ?fct25 TripleTemplate)) (and (eq ?fct25:subject   ?formulacontainer  )  (eq ?fct25:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct25  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifexternal  ))))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#TestPatternExternalGenerator> )))(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))
(not
(exists
(TripleTemplate (subject  ?rifnot ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subpattern ))
)
)
(or
...
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?rifnot ))
	...
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))))

(defrule rule69 (declare (salience -10))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifmember ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
(Member (class  <http://www.w3.org/2007/rif#Subclass> ) (instance  ?rifmember ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifmember ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct31 TripleTemplate)) (and (eq ?fct31:subject   ?formulacontainer  )  (eq ?fct31:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct31  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#SubclassPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))

(defrule rule70 (declare (salience 20))
(TripleTemplate (subject  ?otherrifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifformula ))
(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?otherrifand ))
...
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifand ))
	...
	=>
(assert(TripleTemplate (subject  ?otherrifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?otherrifand )))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifformula ))))
...
(Member (class  <http://clips.script/AndCE> ) (instance  ?superpattern ))
	...
	=>
 (do-for-all-facts (( ?fct35 TripleTemplate)) (and (eq ?fct35:subject   ?formulacontainer  )  (eq ?fct35:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct35  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct30 TripleTemplate)) (and (eq ?fct30:subject   ?superpattern  )  (eq ?fct30:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct30  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer ))))
...
(defrule rule73 (declare (salience 11))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?rifexternal ))
	=>
(assert(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expressions-needs-var> ) (object  ?clipsvar ))))

(defrule rule74 (declare (salience -12))
...
(not
(TripleTemplate (subject  ?rifequal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsassign ))
)
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifequal ))
)
...
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?rifrule ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifformula )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifrule )))(assert(TripleTemplate (subject  ?rifforall ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifformula ))))

(defrule rule76 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsexpression ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#items> ) (object  ?itemlist ))
(Member (class  <http://white.gobo/modelA#ExpressionGenerator> ) (instance  ?riflist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?itemlist   ?rifvar  ))
...
(defrule rule77 (declare (salience 5))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?x  ))
	...
	=>
(assert(Atom (op  <http://white.gobo/local/b/n6951d320_n6554#check-binding> ) (args  ?x ))))

(defrule rule78 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?formula ))
	=>
 (bind ?clipsnot   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsnot )))(assert(Member (instance  ?clipsnot ) (class  <http://clips.script/NotCE> )))(assert(TripleTemplate (subject  ?clipsnot ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule79 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?formula ))
	=>
 (bind ?clipsexists   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsexists )))(assert(Member (instance  ?clipsexists ) (class  <http://clips.script/ExistsCE> )))(assert(TripleTemplate (subject  ?clipsexists ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule80 (declare (salience 5))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer ))
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))))

(defrule rule81 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-binds-var> ) (object  ?clipsconstraint ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
...
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
(assert(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsconstraint ))))

(defrule rule82 (declare (salience -1))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  ?patternlist ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
	...
	=>
 (do-for-all-facts (( ?fct27 TripleTemplate)) (and (eq ?fct27:subject   ?formulacontainer  )  (eq ?fct27:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct27  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct34 TripleTemplate)) (and (eq ?fct34:subject   ?superpattern  )  (eq ?fct34:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct34  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer ))))

(defrule rule83 (declare (salience 5))
(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsconstraint ))
...
(defrule rule85 (declare (salience 11))
...
(Member (class  <http://www.w3.org/2007/rif#External> ) (instance  ?pattern ))
	=>
(assert(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsvar ))))

(defrule rule86 (declare (salience -10))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?subpattern ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subpattern ))
)
(or
...
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
...
(exists
(and
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?subsub ))
(not
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subsub ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct23 TripleTemplate)) (and (eq ?fct23:subject   ?superpattern  )  (eq ?fct23:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct23  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))

(defrule rule87 (declare (salience 5))
...
(not
(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsconstraint ))
)
	=>
(assert(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/modelA#binds-var> ) (object  ?clipsconstraint ))))

(defrule rule88 (declare (salience 5))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?itemlist   ?rifvar  ))
	...
	=>
(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-binds-var> ) (object  ?clipsconstraint ))))

(defrule rule91 (declare (salience 5))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?sentences   ?rifrule  ))
	...
	=>
 (bind ?defrule   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?defrule )))(assert(Member (instance  ?defrule ) (class  <http://clips.script/Defrule> )))(assert(TripleTemplate (subject  ?defrule ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?subformula ))
(Member (class  <http://www.w3.org/2007/rif#And> ) (instance  ?superformula ))
(not
(TripleTemplate (subject  ?superformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subformula ))
)
	=>
(assert(TripleTemplate (subject  ?subformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-as-action> ) (object  ?rifaction ))
(or
...
(TripleTemplate (subject  ?rifmember ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
	...
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifmember ))) (do-for-all-facts (( ?fct24 TripleTemplate)) (and (eq ?fct24:subject   ?formulacontainer  )  (eq ?fct24:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct24  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifmember  ))))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#MemberPatternGenerator> )))(assert(Member (instance  ?rifmember ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?formula ))
	...
	=>
(assert(Member (instance  ?formula ) (class  <http://white.gobo/local/b/n6951d320_n6554#rifformula> ))))
...
(exists
(and
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?riflist ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
...
(defrule rule97 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Or> ) (instance  ?formula ))
	=>
 (bind ?clipsor   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsor )))(assert(Member (instance  ?clipsor ) (class  <http://clips.script/OrCE> )))(assert(TripleTemplate (subject  ?clipsor ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))
...
(not
(TripleTemplate (subject  ?rifframe ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsconstraint ))
)
(or
...
(defrule rule99 (declare (salience 11))
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?rifineg ))
	=>
(assert(TripleTemplate (subject  ?rifineg ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule100 (declare (salience -1))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/modelA#lhs-pattern-after-conditions> ) (object  ?aftercondition ))
(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  ?conditions ))
(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-after-conditions> ) (object  ?andpattern ))
(not
(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transferred-after-condition> ) (object  ?andpattern ))
)
	=>
(assert(TripleTemplate (subject  ?aftercondition ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transferred-after-condition> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct22 TripleTemplate)) (and (eq ?fct22:subject   ?andpattern  )  (eq ?fct22:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct22  ) ) (assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?conditions   ?aftercondition  )))))
...
(TripleTemplate (subject  ?subpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
...
(Member (class  <http://www.w3.org/2007/rif#INeg> ) (instance  ?subpattern ))
	...
	=>
(assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?subpattern ))) (do-for-all-facts (( ?fct32 TripleTemplate)) (and (eq ?fct32:subject   ?superpattern  )  (eq ?fct32:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct32  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?subpattern  )))))

(defrule rule102 (declare (salience 5))
...
(defrule rule103 (declare (salience -100))
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?pattern ))
(not
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?pattern ))
)
	=>
...
(defrule rule104 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?rifterm ))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsexpression ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(Atom (op  <http://white.gobo/local/b/n6951d320_n6554#check-binding> ) (args  ?rifterm ))
(not
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?itemlist   ?rifvar  ))

)
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsexpression ))))
...
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#use-expression-from> ) (object  ?rifexpression ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
	=>
...
(defrule rule107 (declare (salience -10))
...
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsassign ))
)
(not
(exists
(and
(TripleTemplate (subject  ?targetstring ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifexternal ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
	...
	=>
(assert(Member (instance  ?rifexternal ) (class  <http://white.gobo/modelA#AssignGenerator> )))(assert(TripleTemplate (subject  ?targetiri ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#use-expression-from> ) (object  ?targetstring )))(assert(Member (instance  ?targetstring ) (class  <http://white.gobo/modelA#ExpressionGenerator> )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifexternal )))(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?targetstring ))))
...
(defrule rule109 (declare (salience -10))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?rifatom ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  ?formulalist ))
(Member (class  <http://www.w3.org/2007/rif#Atom> ) (instance  ?rifatom ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifatom ))
)
(not
(exists
(and
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?x ))
(not
(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?x ))
)
)
)
)
	=>
(assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?rifatom ))) (do-for-all-facts (( ?fct33 TripleTemplate)) (and (eq ?fct33:subject   ?formulacontainer  )  (eq ?fct33:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct33  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?formulalist   ?rifatom  ))))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#AtomPatternGenerator> )))(assert(Member (instance  ?rifatom ) (class  <http://white.gobo/modelA#PatternGenerator> ))))
...
(defrule rule112 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-constraint> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
...
(TripleTemplate (subject  ?parent ) (predicate  <http://www.w3.org/2007/rif#super> ) (object  ?term ))
	...
	=>
(assert(Atom (op  <http://white.gobo/local/b/n6951d320_n6554#check-binding> ) (args  ?term ))))

(defrule rule114 (declare (salience 11))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
...
(Member (class  <http://www.w3.org/2007/rif#Exists> ) (instance  ?formula ))
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?clipsvar ))))

(defrule rule115 (declare (salience 5))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?formula ))
(not
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#added-pattern-from> ) (object  ?formula ))
)
(or
...
(Member (class  <http://www.w3.org/2007/rif#Implies> ) (instance  ?formulacontainer ))
	...
	=>
(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#bound-variable> ) (object  ?clipsvar ))))

(defrule rule116 (declare (salience 5))
(TripleTemplate (subject  ?rifand ) (predicate  <http://www.w3.org/2007/rif#formulas> ) (object  ?formulalist ))
(or
(Member (class  <http://white.gobo/local/b/n6951d320_n6554#rifformula> ) (instance  ?formula ))
(Member (class  <http://www.w3.org/2007/rif#Member> ) (instance  ?formula ))
)
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?formulalist   ?formula  ))
...
(Member (class  <http://www.w3.org/2007/rif#Or> ) (instance  ?rifand ))
	...
	=>
(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?formula ))))

(defrule rule117 (declare (salience 5))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-needs-var> ) (object  ?clipsvar ))
(TripleTemplate (subject  ?rifatom ) (predicate  <http://www.w3.org/2007/rif#args> ) (object  ?arglist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?rifvar  ))

	=>
(assert(TripleTemplate (subject  ?rifatom ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?clipsvar ))))
...
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?superpattern ))
	...
	=>
 (bind ?andpattern   (<http://white.gobo/new-blanknode>) )(assert(Member (instance  ?andpattern ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?andpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list> ?subpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-after-conditions> ) (object  ?andpattern ))) (do-for-all-facts (( ?fct26 TripleTemplate)) (and (eq ?fct26:subject   ?formulacontainer  )  (eq ?fct26:predicate   <http://white.gobo/local/b/n6951d320_n6554#formulalist>  ) ) (retract ?fct26  ) ) (assert(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?formulalist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct21 TripleTemplate)) (and (eq ?fct21:subject   ?superpattern  )  (eq ?fct21:predicate   <http://clips.script/conditional-element>  ) ) (retract ?fct21  ) ) (assert(TripleTemplate (subject  ?superpattern ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?patternlist   ?andpattern  ))))(assert(TripleTemplate (subject  ?formula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#transfer-variable-binding> ) (object  ?formulacontainer ))))

(defrule rule119 (declare (salience 5))
(or
...
(TripleTemplate (subject  ?rifobj ) (predicate  <http://www.w3.org/2007/rif#pattern> ) (object  ?formula ))
	...
	=>
(assert(TripleTemplate (subject  ?rifobj ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-pattern-from> ) (object  ?formula ))))
...
(TripleTemplate (subject  ?rifrule ) (predicate  <http://www.w3.org/2007/rif#formula> ) (object  ?rifaction ))
	...
	=>
(assert(TripleTemplate (subject  ?rifrule ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-as-action> ) (object  ?rifaction ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?formulalist   ?rifand  ))
	...
	=>
 (bind ?clipsand   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#formulalist> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?rifand ) (predicate  <http://white.gobo/modelA#as-lhs-pattern> ) (object  ?clipsand )))(assert(Member (instance  ?clipsand ) (class  <http://clips.script/AndCE> )))(assert(TripleTemplate (subject  ?clipsand ) (predicate  <http://clips.script/conditional-element> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>)))))

(defrule rule122 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifterm ) (predicate  <http://example.com/inherits-data> ) (object  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsexpression ))
(Atom (op  <http://white.gobo/local/b/n6951d320_n6554#check-binding> ) (args  ?rifterm ))
...
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?rifterm ))
	...
	=>
(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraint-needs-var> ) (object  ?clipsexpression )))(assert(TripleTemplate (subject  ?rifterm ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#expression-needs-var> ) (object  ?clipsexpression ))))
...
(defrule rule124 (declare (salience 5))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rifvar ))
(TripleTemplate (subject  ?rifvar ) (predicate  <http://example.com/as-expression> ) (object  ?clipsvar ))
...
(defrule rule125 (declare (salience 5))
...
(TripleTemplate (subject  ?rifformula ) (predicate  <http://www.w3.org/2007/rif#slotvalue> ) (object  ?rifvar ))
	...
	=>
(assert(TripleTemplate (subject  ?rifformula ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#constraints-needs-variable> ) (object  ?clipsvar ))))
...
(defrule rule130 (declare (salience -12))
(TripleTemplate (subject  ?rifequal ) (predicate  <http://www.w3.org/2007/rif#left> ) (object  ?rifleft ))
(TripleTemplate (subject  ?formulacontainer ) (predicate  <http://white.gobo/modelA#as-defrule> ) (object  ?defrule ))
...
(defrule rule131 (declare (salience 5))
(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-as-action> ) (object  ?sub ))
(TripleTemplate (subject  ?sub ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-as-action> ) (object  ?rifaction ))
	=>
(assert(TripleTemplate (subject  ?super ) (predicate  <http://white.gobo/local/b/n6951d320_n6554#add-as-action> ) (object  ?rifaction ))))

(defrule rule132 (declare (salience 50))
...
(defrule rule134 (declare (salience 10))
(TripleTemplate (subject  ?rifop ) (predicate  <http://example.com/as-expression> ) (object  ?functionsymbol ))
(TripleTemplate (subject  ?functionsymbol ) (predicate  <http://clips.script/symbol> ) (object  ?functionname ))
...
(defrule rule138 (declare (salience 15))
(TripleTemplate (subject  ?function ) (predicate  <http://example.com/add-args-from> ) (object  ?rifarglist ))
(TripleTemplate (subject  ?firstarg ) (predicate  <http://example.com/as-expression> ) (object  ?clipsexpression ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?rifarglist  ))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (bind ?functionargs   (do-for-fact (( ?fct6 TripleTemplate)) (and (eq ?fct6:subject   ?function  )  (eq ?fct6:predicate   <http://clips.script/function-args>  ) ) (fact-slot-value ?fct6   object  ) )  ) (do-for-all-facts (( ?fct38 TripleTemplate)) (and (eq ?fct38:subject   ?function  )  (eq ?fct38:predicate   <http://clips.script/function-args>  ) ) (retract ?fct38  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?functionargs   ?clipsexpression  )))) (do-for-all-facts (( ?fct37 TripleTemplate)) (and (eq ?fct37:subject   ?function  )  (eq ?fct37:predicate   <http://example.com/add-args-from>  ) ) (retract ?fct37  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://example.com/add-args-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?rifarglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))
...
(defrule rule140 (declare (salience 1000))
...
(defrule rule141 (declare (salience 1000))
(TripleTemplate (subject  ?directive ) (predicate  <http://www.w3.org/2007/rif#location> ) (object  ?location ))
(not
(exists
(TripleTemplate (subject  ?directive ) (predicate  <http://www.w3.org/2007/rif#profile> ) (object  ?profile ))
...
(Member (class  <http://www.w3.org/2007/rif#Frame> ) (instance  ?factable ))
	...
	=>
 (bind ?rhspatternlist   (do-for-fact (( ?fct7 TripleTemplate)) (and (eq ?fct7:subject   ?deffacts  )  (eq ?fct7:predicate   <http://clips.script/rhs-pattern>  ) ) (fact-slot-value ?fct7   object  ) )  ) (do-for-all-facts (( ?fct39 TripleTemplate)) (and (eq ?fct39:subject   ?deffacts  )  (eq ?fct39:predicate   <http://clips.script/rhs-pattern>  ) ) (retract ?fct39  ) ) (assert(TripleTemplate (subject  ?deffacts ) (predicate  <http://clips.script/rhs-pattern> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?rhspatternlist   ?newrhspattern  )))))
...
(defrule rule175 (declare (salience 10))
...
(defrule rule176 (declare (salience -1))
...
(defrule rule178 (declare (salience 10))
(TripleTemplate (subject  ?slotitems ) (predicate  <http://clips.script/constraints> ) (object  ?listconstraints ))
(TripleTemplate (subject  ?slotitems ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-constraints-from> ) (object  ?itemlist ))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (do-for-all-facts (( ?fct44 TripleTemplate)) (and (eq ?fct44:subject   ?slotitems  )  (eq ?fct44:predicate   <http://clips.script/constraints>  ) ) (retract ?fct44  ) ) (assert(TripleTemplate (subject  ?slotitems ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?listconstraints   ?clipsconstraint  )))) (do-for-all-facts (( ?fct43 TripleTemplate)) (and (eq ?fct43:subject   ?slotitems  )  (eq ?fct43:predicate   <http://white.gobo/local/b/n6951d320_n1111#add-args-as-constraints-from>  ) ) (retract ?fct43  ) ) (assert(TripleTemplate (subject  ?slotitems ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-constraints-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))

(defrule rule179 (declare (salience 10))
(Member (class  <http://white.gobo/modelA#ExpressionGenerator> ) (instance  ?riflist ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#items> ) (object  ?itemlist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?itemlist  ))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://www.w3.org/2007/rif#rest> ) (object  ?rest ))
	...
	=>
 (bind ?function   (<http://white.gobo/new-blanknode>) )(assert(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/as-expression> ) (object  ?function )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-name> ) (object  "%3Chttp%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-function%23make-list%3E" )))(assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#make-list>))))(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from> ) (object  ?itemlist ))))

(defrule rule180 (declare (salience 10))
(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from> ) (object  ?itemlist ))
(test (<http://www.w3.org/2007/rif-builtin-predicate#is-list> ?itemlist  ))

(test (eq "0^^http://www.w3.org/2001/XMLSchema#integer"   (<http://www.w3.org/2007/rif-builtin-function#count> ?itemlist  ) ))

	=>
 (retract(assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from> ) (object  ?itemlist ))) ))

(defrule rule181 (declare (salience -101))
(TripleTemplate (subject  ?rif ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from> ) (object  ?arglist ))
...
(defrule rule182 (declare (salience 10))
...
(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/add-as-pattern> ) (object  ?defrule ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?rest ))
(Atom (op  <http://white.gobo/local/b/n6951d320_n1111#combine-multifield-as-list> ) (args  ?rest  ?multifieldvar ))
(not
...
(defrule rule183 (declare (salience 10))
...
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
	...
	=>
 (do-for-all-facts (( ?fct40 TripleTemplate)) (and (eq ?fct40:subject   ?function  )  (eq ?fct40:predicate   <http://clips.script/function-args>  ) ) (retract ?fct40  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://clips.script/function-args> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?currentexprlist   ?firstasexpression  )))) (do-for-all-facts (( ?fct41 TripleTemplate)) (and (eq ?fct41:subject   ?function  )  (eq ?fct41:predicate   <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from>  ) ) (retract ?fct41  ) ) (assert(TripleTemplate (subject  ?function ) (predicate  <http://white.gobo/local/b/n6951d320_n1111#add-args-as-expression-from> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?itemlist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))))

(defrule rule184 (declare (salience 10))
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?riflist ))
(Member (class  <http://white.gobo/modelA#ConstraintGenerator> ) (instance  ?riflist ))
	=>
...
(defrule rule185 (declare (salience -1))
(Member (class  <http://www.w3.org/2007/rif#List> ) (instance  ?riflist ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/as-lhs-pattern> ) (object  ?pattern ))
(TripleTemplate (subject  ?defrule ) (predicate  <http://example.com/bound-variable> ) (object  ?listasvar ))
(TripleTemplate (subject  ?riflist ) (predicate  <http://example.com/as-constraint> ) (object  ?listasvar ))
...
(TripleTemplate (subject  ?group ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?localconst ))
...
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))
(or
...
(TripleTemplate (subject  ?parent ) (predicate  <http://www.w3.org/2007/rif#content> ) (object  ?child ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))))
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?slotlist   ?slot  ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?child ))))
...
(TripleTemplate (subject  ?document ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?localconst ))
...
(TripleTemplate (subject  ?rifconstraint ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))
(or
...
(defrule rule196 (declare (salience 80))
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))
	=>
 (retract(assert(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))) ))
...
(Member (class  <http://www.w3.org/2007/rif#Retract> ) (instance  ?child ))
	...
	=>
(assert(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n6951d320_n371#rifdoinheritance> ) (object  ?rifdo ))))
...
(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n6951d320_n371#rifdoinheritance> ) (object  ?parent ))
(test (eq ?var   (<http://www.w3.org/2007/rif-builtin-function#get> ?actionvar   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))
...
(defrule rule202 (declare (salience 100))
(TripleTemplate (subject  ?term ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?target ))
(Member (class  <http://white.gobo/modelA#ConditionGenerator> ) (instance  ?rifformula ))
(or
(TripleTemplate (subject  ?rifformula ) (predicate  <http://www.w3.org/2007/rif#left> ) (object  ?term ))
...
(defrule rule203 (declare (salience 100))
(TripleTemplate (subject  ?rifdo ) (predicate  <http://www.w3.org/2007/rif#actionVar> ) (object  ?actionvar ))
(TripleTemplate (subject  ?child ) (predicate  <http://white.gobo/local/b/n6951d320_n371#give-inheritance> ) (object  ?target ))
...
(defrule rule204 (declare (salience 100))
(TripleTemplate (subject  ?target ) (predicate  <http://white.gobo/local/b/n6951d320_n371#rifdoinheritance> ) (object  ?parent ))
(not
(exists
(and
...
(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n6951d320_n95#add-atom-args-as-constraint> ) (object  ?arglist ))
(TripleTemplate (subject  ?firstarg ) (predicate  <http://example.com/as-constraint> ) (object  ?clipsexpr ))
(test (eq ?firstarg   (<http://www.w3.org/2007/rif-builtin-function#get> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  ) ))

	=>
 (bind ?oldconstraints   (do-for-fact (( ?fct1 TripleTemplate)) (and (eq ?fct1:subject   ?slotargs  )  (eq ?fct1:predicate   <http://clips.script/constraints>  ) ) (fact-slot-value ?fct1   object  ) )  ) (do-for-all-facts (( ?fct47 TripleTemplate)) (and (eq ?fct47:subject   ?slotargs  )  (eq ?fct47:predicate   <http://white.gobo/local/b/n6951d320_n95#add-atom-args-as-constraint>  ) ) (retract ?fct47  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://white.gobo/local/b/n6951d320_n95#add-atom-args-as-constraint> ) (object  (<http://www.w3.org/2007/rif-builtin-function#remove> ?arglist   "0^^http://www.w3.org/2001/XMLSchema#integer"  )))) (do-for-all-facts (( ?fct46 TripleTemplate)) (and (eq ?fct46:subject   ?slotargs  )  (eq ?fct46:predicate   <http://clips.script/constraints>  ) ) (retract ?fct46  ) ) (assert(TripleTemplate (subject  ?slotargs ) (predicate  <http://clips.script/constraints> ) (object  (<http://www.w3.org/2007/rif-builtin-function#append> ?oldconstraints   ?clipsexpr  )))))
