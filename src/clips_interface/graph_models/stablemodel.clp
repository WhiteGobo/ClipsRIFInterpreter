...
(defrule rule-gen14644 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen14651 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen14721 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen14731 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
...
(defrule rule-gen14740 (declare (salience -102))
	(Member
		(instance ?clipsvar)
...
(defrule rule-gen14749 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen14804 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14859 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14880 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen14886 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14899 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14912 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14976 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://example.com/inherits-data>)
		(object ?child))
...
(defrule rule-gen15110 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15138 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-atom-args-as-constraint%3E)
		(object ?arglist))
...
(defrule rule-gen15145 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
...
(defrule rule-gen15176 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen15209 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15213 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen15624 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen15639 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen15658 (declare (salience 11))
	(Member
		(instance ?pattern)
		(class <http://white.gobo/modelA#PatternGenerator>))
		(Member
...
(defrule rule-gen15673 (declare (salience 11))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(Member
...
(defrule rule-gen15769 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen15798 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen15827 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23transfer-after-conditions%3E)
		(object ?andpattern))
...
(defrule rule-gen15837 
	...
	(assert 	(TripleTemplate
		(subject ?subformula)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23bound-variable-through-and%3E)
		(object ?clipsvar)))

)

(defrule rule-gen15846 
(or 	(Member
		(instance ?rifframe)
		(class <http://white.gobo/modelA#TripleTemplateGenerator>))
		(Member
...
(defrule rule-gen15893 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen15906 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen15916 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifframe))
...
(defrule rule-gen15941 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen15953 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifmember))
...
(defrule rule-gen15965 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifatom))
...
(defrule rule-gen15977 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen15991 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen16012 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen16038 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifequal))
...
(defrule rule-gen16064 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?rifexternal))
...
(defrule rule-gen16096 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-pattern-from%3E)
		(object ?subpattern))
...
(defrule rule-gen16181 (declare (salience -100))
	(Member
		(instance ?rifnode)
		(class <http://www.w3.org/2007/rif#Do>))
...
(defrule rule-gen16190 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen16275 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16335 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16364 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#sentences>)
		(object ?sentencelist))
...
(defrule rule-gen16387 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16407 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16430 (declare (salience 10))
	(TripleTemplate
		(subject ?rifdocument)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?rifgroup))
...
(defrule rule-gen16440 (declare (salience 10))
	(TripleTemplate
		(subject ?supergroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16455 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23priority%3E)
		(object ?priority))
...
(defrule rule-gen16505 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate %3Chttp%3A%2F%2Fwhite.gobo%2Flocal%2Fu%2Fa%23add-args-from%3E)
		(object ?rifarglist))
...
(defrule rule-gen16521 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen16528 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen16546 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen16550 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen16556 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://example.com/ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16579 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen16584 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ListAsConstraint>))
		(TripleTemplate
...
(defrule rule-gen16606 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen16629 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen16646 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen16666 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen16676 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen16694 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen16709 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
