...
(defrule rule-gen12983 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13030 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(deffacts rule-gen13047
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen13048 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen13059 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
...
(defrule rule-gen13067 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13092 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13102 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13360 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen13364 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen13864 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen13890 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen13919 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate _:qqtransfer-after-conditions)
		(object ?andpattern))
...
(defrule rule-gen13959 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen13972 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen13982 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifframe))
...
(defrule rule-gen14007 (declare (salience -10))
	(Member
		(instance ?rifmember)
		(class <http://www.w3.org/2007/rif#Member>))
		=>
	(assert 	(Member
		(instance ?rifmember)
		(class <http://example.com/QQ1234>)))

)

(defrule rule-gen14010 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen14022 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen14034 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifatom))
...
(defrule rule-gen14046 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen14058 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14079 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14105 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14131 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen14163 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
...
(defrule rule-gen14233 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen14240 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen14439 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen14446 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen14450 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?list))
...
(defrule rule-gen14502 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen14512 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen14521 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen14576 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen14622 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?atom))
...
(defrule rule-gen14637 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14644 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14709 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen14846 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen14850 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen14856 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://example.com/ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen14879 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen14884 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ListAsConstraint>))
		(TripleTemplate
...
(defrule rule-gen14906 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen14929 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen14946 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen14966 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen14976 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen14994 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen15009 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen15027 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15058 (declare (salience -1))
	(TripleTemplate
		(subject ?rifconstiristring)
		(predicate <http://www.w3.org/2007/rif#constIRI>)
		(object "http%3A%2F%2Fwww.w3.org%2F2007%2Frif-builtin-predicate%23iri-string^^http://www.w3.org/2001/XMLSchema#anyURI"))
...
(defrule rule-gen15091 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15107 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate _:qqadd-atom-args-as-constraint)
		(object ?arglist))
...
(defrule rule-gen15186 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen15193 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
