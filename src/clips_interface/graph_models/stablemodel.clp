...
(defrule rule-gen13082 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen13095 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13106 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13142 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen13171 (declare (salience 10))
	(TripleTemplate
		(subject ?rifparent)
...
(defrule rule-gen13179 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13194 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13204 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen13472 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen13476 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen13516 
	...
	(assert 	(TripleTemplate
		(subject ?x)
		(predicate <http://example.com/qq654>)
		(object ?y)))

)

(defrule rule-gen13520 
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?rifformula))
...
(defrule rule-gen13998 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen14024 (declare (salience -1))
(or 	(Member
		(instance ?superpattern)
		(class <http://clips.script/AndCE>))
		(Member
...
(defrule rule-gen14053 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate _:qqtransfer-after-conditions)
		(object ?andpattern))
...
(defrule rule-gen14111 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen14124 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen14134 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifframe))
...
(defrule rule-gen14159 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen14171 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen14183 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifatom))
...
(defrule rule-gen14228 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14254 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen14280 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen14312 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
...
(defrule rule-gen14382 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen14588 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
...
(defrule rule-gen14595 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen14651 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen14661 (declare (salience -102))
	(Member
		(instance ?clipsvar)
		(class <http://clips.script/Variable>))
	(not(exists 	(TripleTemplate
...
(defrule rule-gen14670 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen14725 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#formula>)
		(object ?child))
...
(defrule rule-gen14771 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#content>)
		(object ?atom))
...
(defrule rule-gen14786 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14793 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14995 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen14999 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen15005 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://example.com/ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen15028 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ConstraintGenerator>))
		(Member
...
(defrule rule-gen15033 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://white.gobo/modelA#ListAsConstraint>))
		(TripleTemplate
...
(defrule rule-gen15055 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen15078 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen15095 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen15115 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen15158 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen15176 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen15240 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15335 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen15342 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
