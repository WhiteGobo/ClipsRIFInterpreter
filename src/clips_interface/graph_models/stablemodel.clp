...
(defrule rule-gen14595 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
...
(defrule rule-gen14602 (declare (salience 1000))
	(TripleTemplate
		(subject ?directive)
		(predicate <http://www.w3.org/2007/rif#location>)
		(object ?location))
...
(defrule rule-gen14672 (declare (salience -100))
	(TripleTemplate
		(subject ?rifvar)
...
(defrule rule-gen14682 (declare (salience -100))
	(TripleTemplate
		(subject ?riflocal)
...
(defrule rule-gen14691 (declare (salience -102))
	(Member
		(instance ?clipsvar)
...
(defrule rule-gen14700 (declare (salience -102))
	(TripleTemplate
		(subject ?rifvar)
		(predicate <http://www.w3.org/2007/rif#varname>)
		(object ?varname))
...
(defrule rule-gen14755 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14825 (declare (salience 100))
	(TripleTemplate
		(subject ?rifdo)
...
(defrule rule-gen14831 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14838 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://www.w3.org/2007/rif#slots>)
		(object ?slotlist))
...
(defrule rule-gen14845 (declare (salience 100))
(or 	(TripleTemplate
		(subject ?parent)
...
(defrule rule-gen14903 (declare (salience 100))
	(TripleTemplate
		(subject ?parent)
		(predicate <http://example.com/inherits-data>)
		(object ?child))
...
(defrule rule-gen15039 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15067 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate _:qqadd-atom-args-as-constraint)
		(object ?arglist))
...
(defrule rule-gen15074 (declare (salience 50))
	(TripleTemplate
		(subject ?rifframe)
...
(defrule rule-gen15105 (declare (salience -1))
	(TripleTemplate
...
(defrule rule-gen15138 (declare (salience -100))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen15142 (declare (salience -100))
	(TripleTemplate
...
(defrule rule-gen15563 (declare (salience 11))
	(Member
		(instance ?rifineg)
		(class <http://www.w3.org/2007/rif#INeg>))
		(TripleTemplate
...
(defrule rule-gen15578 (declare (salience 11))
	(Member
		(instance ?formula)
		(class <http://www.w3.org/2007/rif#Exists>))
		(TripleTemplate
...
(defrule rule-gen15690 (declare (salience -1))
(or 	(Member
...
(defrule rule-gen15745 (declare (salience -1))
	(TripleTemplate
		(subject ?formula)
		(predicate _:qqtransfer-after-conditions)
		(object ?andpattern))
...
(defrule rule-gen15811 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen15824 (declare (salience -10))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(Member
...
(defrule rule-gen15834 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifframe))
...
(defrule rule-gen15859 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen15871 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifmember))
...
(defrule rule-gen15883 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifatom))
...
(defrule rule-gen15895 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen15907 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen15928 (declare (salience -12))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifequal))
...
(defrule rule-gen15980 (declare (salience -10))
	(TripleTemplate
		(subject ?formulacontainer)
		(predicate _:qqadd-pattern-from)
		(object ?rifexternal))
...
(defrule rule-gen16012 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
...
(defrule rule-gen16029 (declare (salience -10))
	(TripleTemplate
		(subject ?superpattern)
		(predicate _:qqadd-pattern-from)
		(object ?subpattern))
...
(defrule rule-gen16106 (declare (salience -100))
	(TripleTemplate
		(subject ?rifnode)
...
(defrule rule-gen16191 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
...
(defrule rule-gen16204 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16215 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(defrule rule-gen16222 (declare (salience 10))
	(TripleTemplate
		(subject ?rifcondition)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16251 (declare (salience 10))
	(TripleTemplate
		(subject ?rifrule)
		(predicate <http://example.com/add-rule-info>)
		(object ?defrule))
...
(deffacts rule-gen16268
		(Atom
		(op <http://example.com/currentdefruleindex>)
		(args "0^^http://www.w3.org/2001/XMLSchema#integer" )))


(defrule rule-gen16269 (declare (salience 10))
(or 	(TripleTemplate
		(subject ?rifparent)
		(predicate <http://www.w3.org/2007/rif#then>)
		(object ?rifformula))
...
(defrule rule-gen16303 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16323 (declare (salience 10))
	(TripleTemplate
		(subject ?rifformula)
		(predicate <http://example.com/add-as-pattern>)
		(object ?defrule))
...
(defrule rule-gen16346 (declare (salience 10))
	(TripleTemplate
		(subject ?rifdocument)
		(predicate <http://www.w3.org/2007/rif#payload>)
		(object ?rifgroup))
...
(defrule rule-gen16371 (declare (salience 10))
	(TripleTemplate
		(subject ?rifgroup)
		(predicate _:qqpriority)
		(object ?priority))
...
(defrule rule-gen16421 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
		(predicate _:qqadd-args-from)
		(object ?rifarglist))
...
(defrule rule-gen16437 (declare (salience 15))
	(TripleTemplate
		(subject ?function)
...
(defrule rule-gen16444 (declare (salience 10))
	(Member
		(instance ?rifexternal)
		(class <http://www.w3.org/2007/rif#External>))
		(TripleTemplate
...
(defrule rule-gen16462 (declare (salience -101))
	(TripleTemplate
		(subject ?rif)
...
(defrule rule-gen16466 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen16472 (declare (salience 10))
	(Member
		(instance ?riflist)
		(class <http://example.com/ExpressionGenerator>))
		(TripleTemplate
...
(defrule rule-gen16522 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen16545 (declare (salience 10))
	(TripleTemplate
		(subject ?formula)
		(predicate <http://white.gobo/modelA#pattern-uses-constraint>)
		(object ?riflist))
...
(defrule rule-gen16582 (declare (salience 10))
	(TripleTemplate
		(subject ?slotitems)
...
(defrule rule-gen16592 (declare (salience 10))
	(TripleTemplate
		(subject ?riflist)
		(predicate <http://www.w3.org/2007/rif#rest>)
		(object ?rest))
...
(defrule rule-gen16610 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen16625 (declare (salience -1))
	(Member
		(instance ?riflist)
		(class <http://www.w3.org/2007/rif#List>))
		(TripleTemplate
...
(defrule rule-gen16985 (declare (salience 10))
	(TripleTemplate
		(subject ?slotargs)
		(predicate <http://example.com/add-atom-args-rhspattern>)
		(object ?arglist))
