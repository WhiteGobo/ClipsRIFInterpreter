...
(TripleTemplate (subject  ?child ) (predicate  <give-inheritance> ) (object  ?target ))
(or
...
(TripleTemplate (subject  ?parent ) (predicate  <http://www.w3.org/2007/rif#if> ) (object  ?child ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <give-inheritance> ) (object  ?target ))))
...
(TripleTemplate (subject  ?document ) (predicate  <give-inheritance> ) (object  ?localconst ))
...
(TripleTemplate (subject  ?rifconstraint ) (predicate  <give-inheritance> ) (object  ?target ))
(or
...
(test (<http://www.w3.org/2007/rif-builtin-predicate#list-contains> ?arglist   ?child  ))
	...
	=>
(assert(TripleTemplate (subject  ?parent ) (predicate  <give-inheritance> ) (object  ?child ))))
...
(TripleTemplate (subject  ?rifnot ) (predicate  <give-inheritance> ) (object  ?target ))
(or
...
(Member (class  <http://www.w3.org/2007/rif#Var> ) (instance  ?target ))
(TripleTemplate (subject  ?term ) (predicate  <give-inheritance> ) (object  ?target ))
...
(TripleTemplate (subject  ?group ) (predicate  <give-inheritance> ) (object  ?localconst ))
	=>
(assert(TripleTemplate (subject  ?document ) (predicate  <http://example.com/inherits-data> ) (object  ?localconst ))))
